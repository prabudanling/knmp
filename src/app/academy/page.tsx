...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        Tingkatkan kapasitas Anda dengan pelatihan digital berkualitas. Gratis untuk anggota KMN BERDIKARI.
      </motion.p>
    </motion.section>
  )
}
      ...
      <Card className="bg-gradient-to-br from-blue-100 to-white border border-blue-200 max-w-2xl mx-auto">
        <CardContent className="p-8">
          ...
          <p className="text-muted-foreground mb-6">
            Daftar sebagai anggota KMN BERDIKARI dan akses semua pelatihan gratis
          </p>
