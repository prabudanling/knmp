...
const babs: BabItem[] = [
    ...
    content: [
      {
        ...
        definisi: [
          { istilah: 'KMN BERDIKARI/KMN BERDIKARI', penjelasan: 'Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih, badan hukum koperasi berdasarkan UU No. 25 Tahun 1992 jo. UU No. 20 Tahun 2008 tentang Koperasi yang menggunakan mekanisme Koperasi Multi Pihak.' },
          ...
          { istilah: 'Wali Amanat Data', penjelasan: 'Mekanisme perlindungan data anggota di mana KMN BERDIKARI bertindak sebagai wali amanat (fiduciary) atas seluruh data yang dikumpulkan, bukan pemilik data.' },
          { istilah: "Arm's Length Principle", penjelasan: 'Prinsip dimana setiap transaksi, perjanjian, atau kerja sama antara KMN BERDIKARI dan pihak ketiga harus dilakukan seolah-olah kedua belah pihak tidak memiliki hubungan istimewa, dengan harga dan syarat yang wajar dan seimbang.' },
          ...
          { istilah: 'Kampung Modal', penjelasan: 'Unit usaha otonom KMN BERDIKARI yang berfungsi sebagai platform equity crowdfunding terdesentralisasi untuk memobilisasi modal dari berbagai sumber guna pembiayaan proyek-proyek produktif di tingkat desa.' },
          { istilah: 'NIAK', penjelasan: 'Nomor Induk Anggota Koperasi, identitas unik digital yang diberikan kepada setiap anggota KMN BERDIKARI yang berfungsi sebagai akses tunggal ke seluruh ekosistem layanan koperasi.' },
    ...
    content: [
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'KMN BERDIKARI (Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih) — digunakan sebagai identitas resmi, legal, dan korporat dalam seluruh dokumen hukum, perizinan, dan korespondensi resmi.' },
          { ayat: '(2)', isi: 'KMN BERDIKARI (Koperasi Nusa Merah Putih) — digunakan sebagai identitas branding, publikasi, dan pemasaran yang lebih singkat dan mudah diingat oleh masyarakat luas.' },
  ...
  },
  {
    ...
    content: [
      ...
      {
        nomor: 'Pasal 6',
        teks: '5 Prinsip Pertahanan Kedaulatan - KMN BERDIKARI menjunjung tinggi lima prinsip pertahanan kedaulatan yang tidak dapat dikompromikan:',
        prinsip: [
          { nama: 'Kedaulatan Data Absolut', deskripsi: 'Seluruh data anggota adalah milik anggota yang bersangkutan. KMN BERDIKARI hanya bertindak sebagai wali amanat (fiduciary) dan tidak memiliki hak kepemilikan atas data.' },
  ...
  },
  {
    ...
    content: [
      {
        nomor: 'Pasal 7',
        teks: 'Visi Singular KMN BERDIKARI:',
        subs: [
          ...
          { ayat: '(3)', isi: 'Target jangka panjang pencapaian visi ditetapkan pada tahun 2045 sebagai bentuk kontribusi KMN BERDIKARI terhadap Indonesia Emas.' }
        ]
      },
      {
        nomor: 'Pasal 8',
        teks: '4 Misi Strategis KMN BERDIKARI:',
        subs: [
      ...
      {
        nomor: 'Pasal 9',
        teks: '13 Pilar Arsitektur Bisnis KMN BERDIKARI:',
        pilar: [
          { nomor: '1', nama: 'NB Pay', deskripsi: 'Sistem pembayaran digital terintegrasi untuk seluruh transaksi dalam ekosistem KMN BERDIKARI.' },
          ...
          { nomor: '6', nama: 'NB Academy', deskripsi: 'Platform pendidikan dan pelatihan digital untuk meningkatkan kapasitas anggota dan masyarakat.' },
  ...
  },
  {
    ...
    content: [
      {
        nomor: 'Pasal 10',
        teks: 'Pentagon Kedaulatan — Keanggotaan KMN BERDIKARI terdiri dari 5 Kelompok Pihak yang Berkepentingan (KPA), masing-masing memiliki suara sebesar 20%:',
        kpa: [
          ...
          { nomor: 'KPA-2', nama: 'Konsumen Umum (Mesin Permintaan)', anggota: 'Pengguna NB Pay, Pembeli Marketplace, Wisatawan', catatan: '20% suara — Pasar internal yang menjamin demand berkelanjutan' },
      ...
      },
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'KPA-2 terdiri dari seluruh pengguna NB Pay, Pembeli Marketplace, dan Wisatawan yang terdaftar dalam ekosistem KMN BERDIKARI.' },
      ...
      },
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'KPA-4 terdiri dari Bandar, PT, CV, BUMDes, dan Koperasi Primer yang berfungsi sebagai Mesin B2B dan kekuatan korporasi dalam ekosistem KMN BERDIKARI.' },
          ...
          { ayat: '(3)', isi: 'Seluruh transaksi antara KPA-4 dan KMN BERDIKARI wajib mematuhi Arm\'s Length Principle sebagaimana diatur dalam Pasal 27.' },
          { ayat: '(4)', isi: 'Entitas bisnis yang terdaftar sebagai anggota KPA-4 wajib memenuhi standar KYC/AML serta mematuhi seluruh ketentuan AD, ART, dan Kode Etik KMN BERDIKARI.' }
        ]
      },
      {
        nomor: 'Pasal 15',
        ...
        subs: [
          { ayat: '(1)', isi: 'KPA-5 terdiri dari Angel Investor, Institusi Keuangan, dan Investor yang berfungsi sebagai sumber Likuiditas Berdaulat dalam ekosistem KMN BERDIKARI.' },
    ...
    content: [
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'Pengurus KMN BERDIKARI diorganisasikan dalam bentuk Presidium Eksekutif dengan nomenklatur BAKORNAS (Badan Koordinasi Nasional).' },
    ...
    content: [
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'Benteng Kampung Modal adalah unit usaha otonom KMN BERDIKARI yang beroperasi dengan mekanisme Ring-Fencing penuh — seluruh aset, liabilitas, dan risiko diisolasi secara total dari entitas induk KMN BERDIKARI.' },
          { ayat: '(2)', isi: 'Ring-Fencing Doktrin — Seluruh aset dan liabilitas Kampung Modal diisolasi dari entitas induk KMN BERDIKARI, sehingga kerugian atau kebangkrutan Kampung Modal tidak menular ke entitas induk, dan sebaliknya.' },
          ...
          { ayat: '(4)', isi: 'Parent Asset Immunity — Aset KMN BERDIKARI sebagai entitas induk tidak dapat digunakan untuk menutup kerugian Kampung Modal, dan sebaliknya.' },
          { ayat: '(5)', isi: 'Pengelolaan Kampung Modal dilakukan oleh tim manajemen yang terpisah dan independen dari Pengurus Bakornas.' },
          { ayat: '(6)', isi: 'Kampung Modal tunduk pada prinsip Anti-Oligarki Finansial sebagaimana diatur dalam Pasal 6 dan Kode Etik KMN BERDIKARI.' }
        ]
      }
    ]
  },
  {
    ...
    content: [
      {
        nomor: 'Pasal 21',
        teks: 'Pembagian Sisa Hasil Usaha (SHU) — Asas Ekilibrium KMN BERDIKARI:',
        subs: [
    ...
    content: [
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'KMN BERDIKARI bertindak sebagai Wali Amanat Data (Data Fiduciary) atas seluruh data yang dikumpulkan dari anggota dan pengguna layanan.' },
          ...
          { ayat: '(3)', isi: 'Data milik anggota — KMN BERDIKARI tidak memiliki hak kepemilikan atas data anggota dan hanya menggunakan data berdasarkan persetujuan yang diberikan.' },
      ...
      },
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'Zero-Knowledge Proof (ZKP) — KMN BERDIKARI menerapkan teknologi ZKP untuk memverifikasi informasi tanpa mengungkapkan data asli kepada pihak ketiga.' },
    ...
    content: [
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'KMN BERDIKARI dapat menjalin aliansi strategis dengan pihak ketiga, baik domestik maupun internasional.' },
          { ayat: '(2)', isi: 'Seluruh aliansi bersifat non-subordinatif — KMN BERDIKARI tidak boleh menjadi subordinat atau anak perusahaan dari entitas manapun.' },
          { ayat: '(3)', isi: 'NB Academy dan platform inti KMN BERDIKARI harus tetap independen dan tidak boleh dikendalikan oleh pihak ketiga melalui mekanisme aliansi.' },
    ...
    content: [
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'KMN BERDIKARI bersikap netral secara absolut dalam politik praktis dan tidak memihak kepada partai politik, calon kepala daerah, maupun kelompok politik manapun.' },
          ...
          { ayat: '(4)', isi: 'Keterlibatan anggota dalam kegiatan politik dilakukan atas kapasitas pribadi dan tidak boleh membawa nama atau atribut KMN BERDIKARI.' }
        ]
      }
    ]
  },
    ...
    content: [
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'Arsitek Konstitusi KMN BERDIKARI adalah Arif Rachman Hakim dan Gugun Gunara sebagai Grand Architect, yang merupakan organ ekstra-struktural di luar struktur pengurus dan pengawas Koperasi.' },
        ...
        <div className="relative container mx-auto px-4 lg:px-8 py-16 md:py-24">
          <motion.div {...fadeInUp} className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4 leading-tight tracking-tight">
              ANGGARAN DASAR
              <br />
              <span className="text-[#FFD700]">KMN BERDIKARI/KMN BERDIKARI</span>
            </h1>
                ...
                <Card className="bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200 shadow-xl">
                  <CardContent className="p-6 md:p-8">
                    ...
                    <div className="text-gray-700 leading-relaxed text-sm md:text-base space-y-3">
                      <p>
                        Dengan rahmat Tuhan Yang Maha Esa, para Pendiri Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih (KMN BERDIKARI atau KMN BERDIKARI) menyadari bahwa kedaulatan ekonomi nasional di abad ke-21 tidak lagi semata-mata diukur dari penguasaan lahan fisik, melainkan dari penguasaan data, integrasi teknologi, dan arsitektur finansial yang berkeadilan.
                      </p>
                      <p>
                      ...
                      <p>
                        Bahwa demi melindungi ekosistem tersebut dari kerentanan kapitalisme predatoris, KMN BERDIKARI/KMN BERDIKARI didirikan dengan mengadopsi prinsip Koperasi Multipihak yang mengawinkan kearifan gotong royong dengan presisi korporasi modern.
                      </p>
                    ...
                    <Card className="bg-gradient-to-r from-[#8B0000] to-[#008F3D] text-white overflow-hidden">
                      <CardContent className="p-6 md:p-8 text-center">
                        ...
                        <p className="text-white/70 mb-6 max-w-xl mx-auto text-sm md:text-base">
                          Anggaran Dasar ini merupakan dokumen hukum resmi KMN BERDIKARI yang dilindungi oleh Undang-Undang
