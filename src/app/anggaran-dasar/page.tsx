    ...
    content: [
      {
        ...
        definisi: [
          { istilah: 'KKMNMP/KNMP', penjelasan: 'Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih, badan hukum koperasi berdasarkan UU No. 25 Tahun 1992 jo. UU No. 20 Tahun 2008 tentang Koperasi yang menggunakan mekanisme Koperasi Multi Pihak.' },
    ...
    content: [
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'KKMNMP (Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih) — digunakan sebagai identitas resmi, legal, dan korporat dalam seluruh dokumen hukum, perizinan, dan korespondensi resmi.' },
                ...
                <Card className="bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200 shadow-xl">
                  <CardContent className="p-6 md:p-8">
                    ...
                    <div className="text-gray-700 leading-relaxed text-sm md:text-base space-y-3">
                      <p>
                        Dengan rahmat Tuhan Yang Maha Esa, para Pendiri Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih (KKMNMP atau KNMP) menyadari bahwa kedaulatan ekonomi nasional di abad ke-21 tidak lagi semata-mata diukur dari penguasaan lahan fisik, melainkan dari penguasaan data, integrasi teknologi, dan arsitektur finansial yang berkeadilan.
                      </p>
                      <p>
