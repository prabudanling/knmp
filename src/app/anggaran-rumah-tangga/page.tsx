...
const babs: BabItem[] = [
    ...
    content: [
      {
        ...
        teks: 'Kedudukan ART',
        subs: [
          { ayat: '(1)', isi: 'ART ini merupakan turunan operasional mutlak dan satu kesatuan yang tidak terpisahkan dari Anggaran Dasar (AD) KMN BERDIKARI/KMN BERDIKARI Super Final Versi 7.' },
    ...
    content: [
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'KMN BERDIKARI/KMN BERDIKARI menetapkan nominal wajib untuk menghimpun Cashflow Raksasa, namun mengharamkan metode penagihan manual (door-to-door) yang merendahkan martabat anggota.' },
          { ayat: '(2)', isi: 'Koperasi mengeksekusi sistem Invisible Dues melalui arsitektur pemotongan otomatis (auto-deduct) di platform kopnusa.id dan dompet digital NB Pay.' }
        ]
      },
      {
        nomor: 'Pasal 3',
        ...
        tabel: {
          ...
          baris: [
            { kategori: 'KPA-1\nProdusen & Pekerja\n(Petani, Nelayan, Peternak, Agen)', pokok: 'Rp 100.000', wajib: 'Rp 50.000', catatan: 'Dikonversi sebagian jadi saldo awal NB Pay' },
            { kategori: 'KPA-2\nKonsumen Umum', pokok: 'Rp 100.000', wajib: 'Rp 50.000', catatan: 'Dipotong otomatis dari sisa kembalian belanja/cashback Marketplace/NB Pay' },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'KMN BERDIKARI/KMN BERDIKARI mengharamkan masuknya uang hasil kejahatan. Seluruh calon anggota KPA-5 wajib melewati protokol KYC dan uji kelayakan AML.' },
      ...
      },
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'KMN BERDIKARI bukanlah bursa saham publik. Lock-up Period: Simpanan Pokok dan penyertaan modal spesifik pada proyek Kampung Modal dikunci minimal 24 bulan.' },
  ...
  },
  {
    ...
    content: [
      {
        nomor: 'Pasal 12',
        teks: 'Klausul Masa Transisi Digital (Pre-NB Pay):',
        subs: [
          { ayat: '(1)', isi: 'Selama platform dompet digital NB Pay masih dalam tahap coding dan belum beroperasi penuh, sistem auto-deduct ditangguhkan.' },
          { ayat: '(2)', isi: 'Seluruh penyetoran dana dilakukan secara manual murni melalui Transfer Bank ke Rekening Escrow Koperasi KMN BERDIKARI.' },
      ...
      },
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'Anggaran Rumah Tangga ini merupakan bagian yang tidak terpisahkan dari Anggaran Dasar KMN BERDIKARI/KMN BERDIKARI.' },
        ...
        <div className="relative container mx-auto px-4 lg:px-8 py-16 md:py-24">
          <motion.div {...fadeInUp} className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/80 mb-3 font-medium">
              Penjabaran Teknis Anggaran Dasar Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih
            </p>
                    ...
                    <Card className="bg-gradient-to-r from-[#008F3D] to-[#004D21] text-white overflow-hidden">
                      <CardContent className="p-6 md:p-8 text-center">
                        ...
                        <p className="text-white/70 mb-6 max-w-xl mx-auto text-sm md:text-base">
                          ART merupakan penjabaran teknis dari Anggaran Dasar KMN BERDIKARI. Kedua dokumen ini
