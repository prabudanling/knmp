...
const mockTiers: Tier[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      'Hak SHU dari Koperasi KMN BERDIKARI',
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-red-50">
      ...
      <div className="bg-gradient-to-r from-[#008F3D] to-[#006B2D] text-white py-8">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-3xl font-bold mb-2">Pendaftaran Anggota KMN BERDIKARI</h1>
          <p className="text-green-100">Bergabunglah dengan Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih</p>
        </div>
      </div>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Selamat! Anda terdaftar sebagai <strong>{tierInfo.name}</strong> ({tierInfo.title}) KMN BERDIKARI
        </p>
      </div>
