              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-orange-700 leading-relaxed">
                    Disclaimer ini merupakan penyangkalan resmi dari Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih (KMN BERDIKARI/KMN BERDIKARI) 
                    berdasarkan AD Versi 7 Super Final. Dengan mengakses dan menggunakan layanan kami, Anda dianggap telah membaca, memahami, 
                    dan menyetujui disclaimer ini beserta seluruh konstitusi KMN BERDIKARI/KMN BERDIKARI (AD/ART/Kode Etik).
                  </p>
                </div>
              </div>
            </CardContent>
