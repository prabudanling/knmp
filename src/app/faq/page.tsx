    ...
    faqs: [
      {
        ...
        answer: 'KNMP (KKMNMP — Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih) adalah koperasi multipihak digital yang mengintegrasikan 83.763 desa Indonesia dengan pasar global. Berlandaskan Pentagon Kedaulatan dengan 5 KPA, kami menghubungkan produsen, konsumen, abdi negara, pelaku usaha, dan pemodal dalam satu ekosistem berdaulat.',
      },
      {
