    ...
    faqs: [
      {
        ...
        answer: 'KMN BERDIKARI (KMN BERDIKARI — Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih) adalah koperasi multipihak digital yang mengintegrasikan 83.763 desa Indonesia dengan pasar global. Berlandaskan Pentagon Kedaulatan dengan 5 KPA, kami menghubungkan produsen, konsumen, abdi negara, pelaku usaha, dan pemodal dalam satu ekosistem berdaulat.',
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'Anggota T3 ke atas dapat menjual produk di Marketplace Zonasi. Produk akan diverifikasi tim KMN BERDIKARI sebelum dipublikasikan. Pembayaran dapat dilakukan melalui NB Pay atau transfer bank.',
      },
      {
        question: 'Bagaimana pembagian SHU?',
        answer: 'SHU dibagikan berdasarkan partisipasi ekonomi anggota sesuai AD/ART KMN BERDIKARI/KMN BERDIKARI. Komposisi: 25% Dana Cadangan, 45% Jasa Usaha Anggota, 10% Jasa Modal, 10% Dana Riset & Teknologi, 5% Dana Sosial & Peradaban, dan 5% Insentif Manajemen. Pembagian dilakukan setelah RAT.',
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'Daftar melalui portal KMN BERDIKARI, pilih program Agen Logistik. Persyaratan: punya lokasi fisik, smartphone, KTP. Setelah training 10 jam dan aktivasi, Anda bisa mulai menerima paket.',
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'Kampung Modal adalah platform agregasi modal berlandaskan prinsip Ring-Fencing yang dikembangkan oleh KMN BERDIKARI/KMN BERDIKARI. Platform ini memungkinkan penghimpunan dana dari berbagai KPA untuk membiayai proyek-proyek strategis desa secara transparan, aman, dan terukur melalui mekanisme Pentagon Kedaulatan.',
      },
      {
        question: 'Bagaimana sistem Invisible Dues?',
        answer: 'Invisible Dues adalah sistem pemotongan otomatis iuran/simpanan wajib anggota melalui platform kopnusa.id dan NB Pay. Setiap transaksi ekonomi anggota akan secara otomatis memotong persentase simpanan wajib sesuai ketentuan ART, sehingga anggota tidak perlu melakukan pembayaran manual.',
      },
      {
        question: 'Siapa Arsitek Konstitusi?',
        answer: 'Arsitek Konstitusi KMN BERDIKARI/KMN BERDIKARI adalah Arif Rachman Hakim dan Gugun Gunara. Keduanya berstatus sebagai Organ Ekstra-Struktural yang bertugas merancang, menjaga, dan mengawal konsistensi konstitusi (AD/ART/Kode Etik) KMN BERDIKARI/KMN BERDIKARI Versi 7 Super Final.',
      },
      {
        question: 'Apa itu Poison Pill?',
        answer: 'Poison Pill (Aset Kedaulatan Tak Terasingkan) adalah aset-aset strategis KMN BERDIKARI/KMN BERDIKARI yang secara konstitusional tidak dapat dijual, digadaikan, dipindahtangankan, atau dialihkan kepada pihak mana pun. Mekanisme ini dirancang untuk melindungi kedaulatan koperasi dan keberlanjutan ekosistem Pentagon Kedaulatan.',
      },
      {
        question: 'Apakah KMN BERDIKARI terdaftar resmi?',
        answer: 'Ya, KMN BERDIKARI terdaftar sebagai badan hukum koperasi dengan Akta Notaris dan SK Kemenkop. Kami beroperasi sesuai UU 25/1992 tentang Perkoperasian dan Permenkop 8/2021 tentang Koperasi Multipihak. Konstitusi terbaru mengacu pada AD/ART/Kode Etik KMN BERDIKARI/KMN BERDIKARI Versi 7 Super Final.',
      },
      {
