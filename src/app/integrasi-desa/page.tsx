...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        KMN BERDIKARI mengintegrasikan seluruh infrastruktur ekonomi desa yang sudah ada tanpa menggantikan peran mereka.
      </motion.p>
    </motion.section>
  )
}
  ...
  const benefits = [
    {
      ...
      description: 'KMN BERDIKARI tidak menggantikan infrastruktur yang sudah ada, hanya mengintegrasikan.',
    },
    {
      icon: Users,
