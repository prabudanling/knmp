...
export default function KebijakanPrivasiPage() {
  const sections = [
    ...
    },
    {
      ...
      content: [
        'KMN BERDIKARI/KMN BERDIKARI bertindak sebagai Wali Amanat Data (Data Fiduciary) bagi seluruh anggota',
    ...
    },
    {
      ...
      content: [
        'Seluruh anggota dan pengelola wajib mematuhi Kode Etik KMN BERDIKARI/KMN BERDIKARI',
          ...
          <Card className="bg-red-50 border-red-100 mb-8">
            <CardContent className="p-6">
              <p className="text-gray-700 leading-relaxed">
                Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih (KMN BERDIKARI/KMN BERDIKARI) berkomitmen untuk melindungi privasi dan keamanan data pribadi 
                anggota dan pengguna platform. Berdasarkan AD Pasal 24-25, KMN BERDIKARI/KMN BERDIKARI bertindak sebagai Wali Amanat Data (Data Fiduciary). 
