...
const babs: BabItem[] = [
    ...
    content: [
      {
        ...
        subs: [
          ...
          { ayat: '(3)', isi: 'b. Melakukan pungutan liar (Pungli) di luar sistem NB Pay kepada anggota di wilayahnya.' },
    ...
    content: [
      {
        ...
        subs: [
          ...
          { ayat: '(5)', isi: 'c. Membawa atribut, bendera, atau yel-yel partai ke dalam Rapat Anggota KMN BERDIKARI/KMN BERDIKARI.' }
        ]
      }
    ]
  },
  {
    nomor: 'VI',
    judul: 'ETIKA ALIANSI STRATEGIS (HUBUNGAN DENGAN NB & MITRA)',
    pasalMulai: '9',
    pasalSelesai: '9',
    ...
    content: [
      {
        ...
        subs: [
          { ayat: '(1)', isi: 'Meskipun KMN BERDIKARI/KMN BERDIKARI memiliki hubungan aliansi historis dan strategis dengan NB (NusaBerdikari), Koperasi ini tetaplah Entitas Berdaulat yang Independen.' },
          { ayat: '(2)', isi: 'Mitra strategis (termasuk pengurus NB) dilarang mengintervensi atau menekan BAKORNAS dalam penentuan kebijakan kas, approval proyek Kampung Modal, atau distribusi Sisa Hasil Usaha (SHU). Seluruh kerja sama wajib tunduk pada Arm\'s Length Principle.' }
        ]
      }
    ]
  },
        ...
        <div className="relative container mx-auto px-4 lg:px-8 py-16 md:py-24">
          <motion.div {...fadeInUp} className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 mb-3 font-medium">
              Etika Peradaban — Pedoman Moral & Tata Tertib Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih
            </p>
            ...
            <section className="container mx-auto px-4 lg:px-8 py-12">
              <motion.div {...fadeInUp} className="text-center mb-10">
                ...
                <p className="text-gray-500 mt-2 max-w-xl mx-auto text-sm">
                  Tujuh pilar etika yang menjadi fondasi moral seluruh aktivitas KMN BERDIKARI/KMN BERDIKARI
                </p>
              </motion.div>
                    ...
                    <Card className="bg-gradient-to-br from-[#0a0a0a] via-[#1a1a1a] to-[#2d0a0a] text-white overflow-hidden">
                      <CardContent className="p-6 md:p-8 text-center">
                        ...
                        <p className="text-white/60 mb-6 max-w-xl mx-auto text-sm md:text-base">
                          Kode Etik ini merupakan jaminan bahwa KMN BERDIKARI/KMN BERDIKARI akan selalu berjalan di atas
