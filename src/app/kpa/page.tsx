                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      },
                      {
                        ...
                        desc: "Tim KMN BERDIKARI akan memverifikasi dokumen dan data Anda (KYC untuk KPA-5)",
                        color: "#8b5cf6",
                      },
                      {
                        step: 4,
                        title: "Setor Simpanan Pokok",
                        desc: "Lakukan pembayaran simpanan pokok sesuai nominal KPA yang dipilih via NB Pay",
                        color: "#f59e0b",
                      },
                      {
                        step: 5,
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Hubungi tim membership KMN BERDIKARI untuk konsultasi gratis pemilihan KPA yang tepat
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-white/60 text-lg mb-10 max-w-2xl mx-auto">
              ...
              abdi negara, pelaku usaha, dan investor dalam satu wadah demokratis — KMN BERDIKARI/KMN BERDIKARI
            </p>
