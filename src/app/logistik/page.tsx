  ...
  const steps = [
    {
      ...
      description: 'Daftar online via aplikasi KMN BERDIKARI. Verifikasi data diri dan lokasi usaha.',
      icon: Users,
      color: '#8B0000',
    },
    {
        ...
        >
          <motion.div variants={fadeInUp} className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Hitung potensi penghasilan Anda sebagai agen logistik KMN BERDIKARI
            </p>
          </motion.div>
    ...
    <section ref={ref} className="py-20 bg-gradient-to-b from-white to-red-50">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-muted-foreground max-w-2xl mx-auto">
            Temui para agen logistik yang sudah sukses bergabung dengan KMN BERDIKARI
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
              Daftar sebagai agen logistik KMN BERDIKARI dan dapatkan penghasilan tambahan
