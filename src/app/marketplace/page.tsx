    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        >
          ...
          >
            Marketplace Zonasi{' '}
            <span className="text-gradient-gold">KMN BERDIKARI</span>
          </motion.h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Setiap zona dirancang untuk kategori produk spesifik dengan dukungan penuh dari ekosistem KMN BERDIKARI
          </motion.p>
        </motion.div>
    ...
    <section className="py-20 bg-background">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Proses mudah dan transparan untuk mulai berjualan di Marketplace KMN BERDIKARI
          </motion.p>
        </motion.div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.h2 variants={fadeInUp} className="text-responsive-title font-bold mb-4 text-white">
            Keuntungan Jadi <span className="text-gradient-gold">Seller KMN BERDIKARI</span>
          </motion.h2>
    ...
    <section className="py-20 bg-background">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Setiap produk di Marketplace KMN BERDIKARI dilengkapi dengan sertifikasi untuk menjamin kualitas dan keamanan
          </motion.p>
        </motion.div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <motion.h2 variants={fadeInUp} className="text-responsive-title font-bold text-white mb-6">
            Mulai Berjualan di{' '}
            <span className="text-gradient-gold">Marketplace KMN BERDIKARI</span>
          </motion.h2>
