...
const TIERS = [
  {
    ...
    benefits: [
      ...
      { text: 'Akses NB Academy Tingkat 1', included: true },
  ...
  },
  {
    ...
    benefits: [
      ...
      { text: 'Hak Prioritas Kemitraan Wilayah', included: false },
      { text: 'Hak Usaha Operasional KMN BERDIKARI', included: false },
    ],
    cta: 'Daftar Sekarang',
    popular: true,
    isFree: false,
  },
  {
    ...
    benefits: [
      ...
      { text: 'Hak Usaha Operasional via KMN BERDIKARI', included: true },
      { text: 'Agen Logistik (J&T, JNE, SiCepat)', included: true },
      { text: 'Dashboard Agen Realtime', included: true },
      { text: 'Hak SHU dari Koperasi KMN BERDIKARI', included: true },
      { text: 'Hak Suara RAT KMN BERDIKARI', included: true },
      { text: 'Akses Dewan Nasional NB', included: false },
    ],
    cta: 'Daftar Sekarang',
    popular: false,
    isFree: false,
  ...
  },
  {
    ...
    benefits: [
      ...
      { text: 'Akses Dewan Nasional NB', included: true },
    ...
    >
      ...
      <motion.div variants={fadeInUp}>
        <Badge className="bg-red-100 text-[#8B0000] border-red-200 mb-4">
          ...
          7 Level Pimpinan KMN BERDIKARI
        </Badge>
      </motion.div>
      <motion.h1
        variants={fadeInUp}
      ...
      >
        ...
        Setiap tier membuka akses ke ekosistem NB × KMN BERDIKARI yang berbeda.
      </motion.p>
      <motion.div
        variants={fadeInUp}
...
function BenefitsSection() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Jadi agen resmi J&T, JNE, SiCepat di bawah payung KMN BERDIKARI. Revenue harian.',
    },
    {
      icon: Wallet,
    ...
    },
    {
      ...
      description: 'NB (NusaBerdikari) Asosiasi + KMN BERDIKARI Koperasi. Badan hukum resmi, blockchain verified.',
    },
  ]
  ...
  return (
    ...
    >
      <motion.div variants={fadeInUp} className="mb-8 text-center">
        ...
        <p className="text-muted-foreground">
          Benefit yang Anda dapatkan sebagai bagian dari ekosistem NB × KMN BERDIKARI
        </p>
      </motion.div>
...
function FAQSection() {
  ...
  const faqs = [
    {
      question: 'Apa perbedaan NB dan KMN BERDIKARI?',
      answer:
        'NB (NusaBerdikari) adalah asosiasi pengusaha (nirlaba) yang fokus pada narasi, branding, dan investor relations. KMN BERDIKARI adalah koperasi multipihak yang menjalankan operasional usaha (logistik, marketplace, fintech). Tier 1-2 adalah keanggotaan asosiasi murni. Tier 3+ membuka akses ke operasional KMN BERDIKARI.',
    },
    {
      question: 'Kapan saya mendapat hak usaha logistik?',
      answer:
        'Hak usaha logistik (agen J&T, JNE, SiCepat, dll) tersedia untuk Tier 3 (KORDES) ke atas, setelah KMN BERDIKARI berbadan hukum dan MoU dengan ekspedisi ditandatangani. Estimasi: Q2-Q3 2026.',
    },
    {
    ...
    {
      question: 'Bagaimana sistem voting di RAT KMN BERDIKARI?',
      answer:
    ...
    },
    {
      ...
      answer:
        'HPKW memberikan prioritas eksklusif untuk menjadi koordinator/mitra utama NB dan KMN BERDIKARI di wilayah tertentu (desa/kecamatan/kabupaten/provinsi/nasional). Ini berarti prioritas dalam pembukaan unit usaha, koordinasi agen, dan akses proyek pemerintah di wilayah tersebut.',
    },
    {
