...
import { ArrowRight, BookOpen, Building2, ChevronRight, DollarSign, Flower2, Globe, Globe2, GraduationCap, Handshake, Heart, Home, Landmark, Laptop, PiggyBank, Scale, Target, TrendingUp, Truck, Users, Warehouse, Wheat, Zap } from 'lucide-react'
...
const kampungModalFeatures = [
  ...
  },
  {
    ...
    description: 'Platform AI untuk mencocokkan investor dengan peluang usaha yang relevan di desa/kelurahan.',
    icon: Handshake,
  ...
  {
    title: 'Pusat Diklat',
    description: 'Pusat pendidikan dan pelatihan untuk meningkatkan kapasitas SDM industri di desa/kelurahan.',
    icon: GraduationCap,
    features: ['Digital Training', 'Certification', 'Mentoring Program'],
  },
]

export default function DesaKampungModalPage() {
  return (
      ...
      <div className="bg-[#F5F5F5] border-b border-[#E5E7EB]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="flex items-center gap-2 text-sm text-[#6B7280]">
            ...
            <span className="flex items-center gap-2">
              <ChevronRight className="w-4 h-4" />
              <Link href="/nusa-futuristik/desa" className="hover:text-[#008F3D]">Desa/Kelurahan</Link>
            </span>
            <span className="flex items-center gap-2">
              <ChevronRight className="w-4 h-4" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            <motion.p variants={fadeInUp} className="text-lg text-white/80 max-w-2xl mx-auto">
              DIPUNTARA melalui BUMDes, Kelompok Tani, Nelayan, Peternak, Perikanan, dan KDMP mengelola investasi di tingkat desa. Kampung Modal menjadi jembatan modal dan produksi desa.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2 variants={fadeInUp} className="text-2xl md:text-3xl font-extrabold text-[#1A1A1A] mb-6">
              Ekosistem Industri Desa/Kelurahan
            </motion.h2>
            <motion.div variants={fadeInUp} className="space-y-4 text-[#6B7280] leading-relaxed">
              <p>
                Ekosistem Industri di tingkat desa/kelurahan dirancang untuk menciptakan sinergi
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">
              ...
              Daftarkan diri Anda dan mulai berinvestasi untuk pembangunan desa/kelurahan.
            </motion.p>
            <motion.div variants={fadeInUp}>
              <Link href="/daftar">
