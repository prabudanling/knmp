...
import { ArrowRight, Building2, ChevronRight, Droplets, Flower2, Globe, GraduationCap, Heart, Home, Laptop, Scale, Sprout, Store, Target, Tractor, TreePine, Truck, Warehouse, Wheat, Zap } from 'lucide-react'
      ...
      <section className="py-12 bg-gradient-to-r from-[#8B0000] to-[#6B0000] text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">Bergabung dengan KMN BERDIKARI dan berkontribusi pada kedaulatan pangan dari tingkat desa.</motion.p>
