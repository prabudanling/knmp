...
const subPages = [
  ...
  },
  {
    ...
    icon: Scale,
    description: 'DIPUNTARA BUMDes, Kelompok Tani, Nelayan, Peternak, Perikanan, KDMP, Ekosistem Industri Desa — Adhikara Artha.',
    color: '#f59e0b',
  },
  {
    ...
    icon: Warehouse,
    description: 'Resi Gudang Digital, Penampung Hasil Industri, Pusat Pemasaran Digital, Hilirisasi — Adhikara Krada.',
    color: '#8B0000',
  },
  {
    ...
    icon: Wheat,
    description: 'Hilirisasi Peternakan, Perikanan, Pertanian, Perkebunan — Integrasi Ekosistem Desa — Adhikara Anna.',
    color: '#16a34a',
  },
  {
    label: 'Kampung Sehat',
    ...
    icon: Heart,
    description: 'Puskesdes Digital, Dokter Digital, Kawasan Olahraga, Wisata Edukasi & Healing — Adhikara Roga.',
    color: '#dc2626',
  },
  {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2 variants={fadeInUp} className="text-2xl md:text-3xl font-extrabold text-[#1A1A1A] mb-2">
              9 Kampung Desa / Kelurahan Futuristik
            </motion.h2>
