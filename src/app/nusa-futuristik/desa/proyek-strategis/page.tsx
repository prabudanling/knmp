...
import { ArrowRight, Building2, ChevronRight, Droplets, Flower2, Globe, Heart, Home, Laptop, Scale, School, Shield, Sun, Target, Truck, Warehouse, Wheat, Wifi, Zap } from 'lucide-react'
      ...
      <section className="py-12 bg-gradient-to-r from-[#008F3D] to-[#006F30] text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">Bergabung dengan KMN BERDIKARI dan jadilah bagian dari pembangunan desa digital seluruh Indonesia.</motion.p>
