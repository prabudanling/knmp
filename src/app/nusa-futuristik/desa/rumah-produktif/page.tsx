...
import { Apple, ArrowRight, Bath, Building2, ChevronRight, Droplets, Fish, Flower2, Globe, GraduationCap, Heart, Home, Laptop, Scale, ShieldCheck, ShoppingBag, Target, Truck, Users, Warehouse, Wheat, Zap } from 'lucide-react'
...
export default function DesaRumahProduktifPage() {
  return (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            <motion.p variants={fadeInUp} className="text-lg text-white/80 max-w-2xl mx-auto">
              Program Rumah Produktif di tingkat desa/kelurahan menyediakan 6 fasilitas utama
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">
              Bergabung dengan KMN BERDIKARI dan jadilah bagian dari program Rumah Produktif
              di desa/kelurahan. Kesejahteraan dimulai dari rumah.
            </motion.p>
            <motion.div variants={fadeInUp}>
              <Link href="/daftar">
