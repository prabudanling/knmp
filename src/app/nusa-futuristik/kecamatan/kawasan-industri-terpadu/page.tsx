...
import { ArrowRight, Building2, ChevronRight, Cpu, Flower2, Globe, GraduationCap, Hammer, Heart, Home, Laptop, Package, Scale, Store, Target, Truck, Users, Wheat, Zap } from 'lucide-react'
      ...
      <section className="py-12 bg-gradient-to-r from-[#008F3D] to-[#006F30] text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">Bergabung dengan KMN BERDIKARI dan akses peluang pemberdayaan UMKM di kecamatan seluruh Indonesia.</motion.p>
