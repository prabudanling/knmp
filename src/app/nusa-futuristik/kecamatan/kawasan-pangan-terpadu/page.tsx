...
import { ArrowRight, Building2, ChevronRight, Droplets, Flower2, Globe, GraduationCap, Heart, Home, Laptop, Scale, Sprout, Store, Target, Tractor, Truck, Warehouse, Wheat, Zap } from 'lucide-react'
...
const zones = [
  { title: 'Lumbung Pangan Kecamatan', description: 'Gudang penyimpanan pangan kecamatan dengan monitoring stok digital dan sistem distribusi terintegrasi.', icon: Warehouse, features: ['Smart Storage', 'Stock Monitor', 'Distribution'] },
  { title: 'Pertanian Organik Terpadu', description: 'Kawasan pertanian organik kecamatan dengan sertifikasi dan akses pasar premium.', icon: Sprout, features: ['Organic Cert', 'Premium Market', 'Training'] },
  { title: 'Irigasi & Air Bersih', description: 'Sistem irigasi cerdas dan pengelolaan sumber daya air untuk mendukung ketahanan pangan.', icon: Droplets, features: ['Smart Irrigate', 'Water Mgmt', 'Clean Water'] },
  { title: 'Peternakan Terpadu', description: 'Sentra peternakan kecamatan dengan teknologi modern dan biosecurity terstandar.', icon: Tractor, features: ['Modern Farm', 'Bio Security', 'Health Check'] },
  { title: 'Pasar Pangan Lokal', description: 'Pasar pangan kecamatan yang terhubung dengan jaringan distribusi nasional melalui platform digital.', icon: Store, features: ['Digital Market', 'Local First', 'Quality Assure'] },
  { title: 'Food Security Dashboard', description: 'Dashboard monitoring ketahanan pangan kecamatan dengan data real-time dan early warning system.', icon: Wheat, features: ['Real-time Data', 'Early Warning', 'Analytics'] },
]

export default function KecamatanKawasanPanganPage() {
  return (
      ...
      <section className="relative bg-gradient-to-r from-[#008F3D] to-[#006F30] text-white py-12 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            <motion.div variants={fadeInUp}><Badge className="bg-white/20 text-white border-white/30 mb-4"><Wheat className="w-3.5 h-3.5 mr-1.5" />KECAMATAN FUTURISTIK</Badge></motion.div>
            <motion.h1 variants={fadeInUp} className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4">Kawasan Pangan Terpadu Kecamatan</motion.h1>
            <motion.p variants={fadeInUp} className="text-lg text-white/80 max-w-2xl mx-auto">Pusat produksi dan distribusi pangan lokal di tingkat kecamatan untuk memperkuat ketahanan pangan nasional dari akar rumput.</motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="mb-8">
            <motion.h2 variants={fadeInUp} className="text-2xl md:text-3xl font-extrabold text-[#1A1A1A] mb-2">Zona Pangan Kecamatan</motion.h2>
            <motion.p variants={fadeInUp} className="text-[#6B7280]">Berbagai zona pangan kecamatan untuk ketahanan pangan dari tingkat akar rumput.</motion.p>
          </motion.div>
      ...
      <section className="py-12 bg-gradient-to-r from-[#8B0000] to-[#6B0000] text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <motion.h2 variants={fadeInUp} className="text-2xl md:text-3xl font-extrabold mb-4">Dukung Pangan Lokal Kecamatan</motion.h2>
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">Bergabung dengan KMN BERDIKARI dan berkontribusi pada ketahanan pangan dari tingkat kecamatan.</motion.p>
