...
import { ArrowRight, Bike, Building2, ChevronRight, Flower2, Globe, GraduationCap, Heart, Home, Laptop, MapPin, Navigation, Package, Scale, Target, Truck, Warehouse, Wheat, Wifi, Zap } from 'lucide-react'
...
const systems = [
  ...
  { title: 'Navigasi Pedesaan', description: 'Aplikasi navigasi untuk rute-rute pedesaan yang belum terpetakan di GPS konvensional.', icon: Navigation, features: ['Offline Map', 'Trail Nav', 'Area Map'] },
  { title: 'Transportasi Umum Cerdas', description: 'Sistem transportasi umum kecamatan dengan jadwal digital dan real-time tracking.', icon: Bike, features: ['Digital Schedule', 'Live Track', 'Smart Fare'] },
  { title: 'Kurir Desa Digital', description: 'Jaringan kurir lokal kecamatan untuk pengiriman paket antar desa dan ke kota.', icon: Package, features: ['Local Courier', 'Same Day', 'Cashless Pay'] },
  { title: 'Connectivity Kecamatan', description: 'Jaringan internet dan komunikasi digital yang menjangkau seluruh wilayah kecamatan.', icon: Wifi, features: ['Internet', 'VoIP', 'Emergency Net'] },
  { title: 'Smart Parking & Terminal', description: 'Terminal dan area parkir kecamatan dengan sistem manajemen digital terintegrasi.', icon: MapPin, features: ['Smart Terminal', 'Auto Park', 'Cashless'] },
]

export default function KecamatanTransportasiPage() {
  return (
      ...
      <section className="relative bg-gradient-to-r from-[#0d9488] to-[#0f766e] text-white py-12 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            <motion.div variants={fadeInUp}><Badge className="bg-white/20 text-white border-white/30 mb-4"><Zap className="w-3.5 h-3.5 mr-1.5" />KECAMATAN FUTURISTIK</Badge></motion.div>
            <motion.h1 variants={fadeInUp} className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4">Transportasi Digital Kecamatan</motion.h1>
            <motion.p variants={fadeInUp} className="text-lg text-white/80 max-w-2xl mx-auto">Sistem transportasi dan logistik digital yang menghubungkan kecamatan dengan desa dan kota untuk konektivitas seamless.</motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="mb-8">
            <motion.h2 variants={fadeInUp} className="text-2xl md:text-3xl font-extrabold text-[#1A1A1A] mb-2">Sistem Transportasi Kecamatan</motion.h2>
            <motion.p variants={fadeInUp} className="text-[#6B7280]">Solusi mobilitas dan logistik digital untuk konektivitas kecamatan yang lebih baik.</motion.p>
          </motion.div>
      ...
      <section className="py-12 bg-gradient-to-r from-[#008F3D] to-[#006F30] text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <motion.h2 variants={fadeInUp} className="text-2xl md:text-3xl font-extrabold mb-4">Hubungkan Kecamatan dengan Digital</motion.h2>
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">Bergabung dengan KMN BERDIKARI dan jadilah bagian dari revolusi transportasi digital kecamatan Indonesia.</motion.p>
