...
const subPages = [
  ...
  },
  {
    ...
    icon: Scale,
    description: 'DIPUNTARA Holding Kab/Kota, Equity Crowdfunding, Pusat Diklat, Ekosistem Industri Kota — Adhikara Artha.',
    color: '#f59e0b',
  },
  {
  ...
  },
  {
    ...
    icon: Heart,
    description: 'Puskesmas Digital, Dokter Digital, Kawasan Olahraga, Wisata Edukasi & Kuliner — Adhikara Roga.',
    color: '#dc2626',
  },
  {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2 variants={fadeInUp} className="text-2xl md:text-3xl font-extrabold text-[#1A1A1A] mb-2">
              9 Kampung Kota / Kabupaten Futuristik
            </motion.h2>
