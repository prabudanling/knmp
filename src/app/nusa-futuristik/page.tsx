...
import {
  ...
  Leaf, Droplets, Fish, Apple, Scale, Building, Clock, Rocket, Flag, Laptop, Flower2, Wheat
} from 'lucide-react'
...
const pillars = [
  ...
  {
    icon: Warehouse,
    label: 'Kampung Industri',
    desc: 'Resi Gudang Digital, Penampung Hasil Industri, Pemasaran Digital, Industri Hilirisasi — Adhikara Krada',
    color: '#8B0000',
  },
  {
    icon: Wheat,
    label: 'Kampung Pangan',
    desc: 'Hilirisasi Peternakan, Perikanan, Pertanian, Perkebunan Terintegrasi — Adhikara Anna',
    color: '#16a34a',
  },
  {
    icon: Heart,
    label: 'Kampung Sehat',
    desc: 'Layanan Kesehatan Digital, Dokter Digital, Kawasan Olahraga, Wisata Terpadu — Adhikara Roga',
    color: '#dc2626',
  },
  {
    icon: GraduationCap,
    label: 'Kampung Cerdas',
    desc: 'Pendidikan Digital, Pelatihan Vokasi, Sertifikasi Kompetensi, NB Academy — Adhikara Vidya',
    color: '#7c3aed',
  },
  {
    icon: Truck,
  ...
  },
  {
    icon: Flower2,
    label: 'Kampung Hijau',
    desc: 'Energi Terbarukan, Daur Ulang, Konservasi Alam, Ekosistem Berkelanjutan — Adhikara Prakriti',
    color: '#059669',
  },
  {
    icon: Home,
    label: 'Kampung Wisata',
    desc: 'Desa Wisata, Homestay, Eco-Tourism, Wisata Budaya & Kuliner — Adhikara Ramya',
    color: '#92400e',
  },
]
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-20 bg-[#F5F5F5]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl font-extrabold text-[#1A1A1A] mb-4">
              9 Kampung Transformasi
            </motion.h2>
            <motion.p variants={fadeInUp} className="text-[#6B7280] max-w-2xl mx-auto text-lg">
              Setiap level wilayah memiliki sembilan pilar utama yang menjadi fondasi
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-lg text-[#6B7280] leading-relaxed mb-8">
              Nusa Futuristik adalah framework strategis KMN BERDIKARI untuk mentransformasi seluruh wilayah Indonesia
              menjadi wilayah yang maju, berdaya saing, dan berkelanjutan. Melalui 9 Kampung di 4 Level Wilayah,
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-3">
              {[
                ...
                'Pendidikan & Kampung Cerdas',
                'Niaga & Logistik Digital',
                'Infrastruktur Digital',
                'Energi Hijau & Konservasi',
