...
const kampungModalFeatures = [
  ...
  },
  {
    ...
    description: 'Platform AI untuk mencocokkan investor dengan peluang usaha yang relevan di provinsi.',
    icon: Handshake,
  ...
  {
    title: 'Pusat Diklat',
    description: 'Pusat pendidikan dan pelatihan untuk meningkatkan kapasitas SDM industri di provinsi.',
    icon: GraduationCap,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            <motion.p variants={fadeInUp} className="text-lg text-white/80 max-w-2xl mx-auto">
              DIPUNTARA Holding Provinsi mengelola investasi dan ekosistem industri di tingkat provinsi. Melalui Kampung Modal, setiap provinsi memiliki platform investasi, pembiayaan, dan pendampingan UMKM yang terintegrasi.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2 variants={fadeInUp} className="text-2xl md:text-3xl font-extrabold text-[#1A1A1A] mb-6">
              Ekosistem Industri Provinsi
            </motion.h2>
            <motion.div variants={fadeInUp} className="space-y-4 text-[#6B7280] leading-relaxed">
              <p>
                Ekosistem Industri di tingkat provinsi dirancang untuk menciptakan sinergi
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">
              ...
              Daftarkan diri Anda dan mulai berinvestasi untuk pembangunan provinsi.
            </motion.p>
            <motion.div variants={fadeInUp}>
              <Link href="/daftar">
