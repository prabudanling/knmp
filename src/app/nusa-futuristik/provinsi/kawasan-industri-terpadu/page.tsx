...
import { ArrowRight, Building2, ChevronRight, Cpu, Factory, Flower2, Globe, GraduationCap, Heart, Home, Laptop, Leaf, Package, Scale, Target, Truck, Users, Wheat, Zap } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">
              Bergabung dengan KMN BERDIKARI dan akses peluang investasi di kawasan industri 
