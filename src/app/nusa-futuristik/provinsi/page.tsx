...
const subPages = [
  {
    ...
    icon: Scale,
    description: 'DIPUNTARA Holding Provinsi, Equity Crowdfunding, Pusat Diklat, Ekosistem Industri Provinsi — Adhikara Artha.',
    color: '#f59e0b',
  },
  {
    ...
    icon: Warehouse,
    description: 'Resi Gudang Digital, Penampung Hasil Industri, Pusat Pemasaran Digital, Industri Hilirisasi — Adhikara Krada.',
    color: '#8B0000',
  },
  {
    ...
    icon: Wheat,
    description: 'Hilirisasi Peternakan, Perikanan, Pertanian, Perkebunan — Integrasi Ekosistem — Adhikara Anna.',
    color: '#16a34a',
  },
  {
    label: 'Kampung Sehat',
    ...
    icon: Heart,
    description: 'Layanan Kesehatan Digital, Dokter Digital, Kawasan Olahraga, Wisata Terpadu — Adhikara Roga.',
    color: '#dc2626',
  },
  {
    ...
    icon: GraduationCap,
    description: 'Pendidikan Digital, Pelatihan Vokasi, Sertifikasi Kompetensi, NB Academy — Adhikara Vidya.',
    color: '#7c3aed',
  },
  {
    label: 'Kampung Niaga',
  ...
  },
  {
    ...
    href: '/nusa-futuristik/provinsi/proyek-strategis',
    icon: Flower2,
    description: 'Energi Terbarukan, Daur Ulang, Konservasi Alam, Ekosistem Berkelanjutan — Adhikara Prakriti.',
    color: '#059669',
  },
  {
    ...
    icon: Home,
    description: 'Desa Wisata, Homestay, Eco-Tourism, Wisata Budaya & Kuliner — Adhikara Ramya.',
    color: '#92400e',
  },
]
      ...
      <section className="py-12 md:py-16 bg-[#F5F5F5]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="space-y-4 text-[#6B7280] leading-relaxed">
              <p>
                Program Provinsi Futuristik merupakan langkah strategis KMN BERDIKARI dalam mentransformasi
