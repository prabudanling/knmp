...
import { ArrowRight, Building2, ChevronRight, Construction, Flower2, Globe, Heart, Home, Landmark, Laptop, Scale, Shield, Target, TrendingUp, Truck, Warehouse, Wheat, Zap } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">
              Bergabung dengan KMN BERDIKARI dan jadilah bagian dari proyek-proyek transformasi 
