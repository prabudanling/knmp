...
import { ArrowRight, Building2, Bus, Car, ChevronRight, Flower2, Globe, GraduationCap, Heart, Home, Laptop, Navigation, Plane, Scale, Target, Train, Truck, Warehouse, Wheat, Wifi, Zap } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-white/80 max-w-xl mx-auto mb-6">
              Bergabung dengan KMN BERDIKARI dan jadilah bagian dari revolusi transportasi digital 
