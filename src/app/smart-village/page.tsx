    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/30">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-primary/10 via-secondary/10 to-primary/10 p-8 lg:p-12">
          ...
          <div className="relative max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Bergabung dengan ribuan desa yang telah terintegrasi dalam ekosistem KMN BERDIKARI
            </p>
      ...
      <footer className="border-t border-border/50 py-6">
        <div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
          <p>
            © 2026 KMN BERDIKARI - Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih. Smart Village Dashboard.
          </p>
        </div>
      </footer>
    </div>
