...
const HIERARKI_KOMANDO = [
  ...
  { tingkat: 'II', nama: 'BAKORWIL', namaLengkap: 'Badan Koordinasi Wilayah', sebutan: 'Panglima Wilayah', wilayah: 'Provinsi (34 Wilayah)', padanan: 'Koordinator Provinsi — Setara Gubernur KOPNUSA', icon: MapPin, color: '#008F3D' },
  { tingkat: 'III', nama: 'BAKORDA', namaLengkap: 'Badan Koordinasi Daerah', sebutan: 'Panglima Distrik', wilayah: 'Kabupaten/Kota (514 Daerah)', padanan: 'Koordinator Daerah — Setara Bupati/Wali Kota KOPNUSA', icon: Building2, color: '#1a1a2e' },
  { tingkat: 'IV', nama: 'BAKORCAM', namaLengkap: 'Badan Koordinasi Kecamatan', sebutan: 'Panglima Sektor', wilayah: 'Kecamatan (7.266 Sektor)', padanan: 'Koordinator Kecamatan — Setara Camat KOPNUSA', icon: Network, color: '#059669' },
  { tingkat: 'V', nama: 'BAKORDEKA', namaLengkap: 'Badan Koordinasi Desa/Kelurahan', sebutan: 'Komandan Lapangan', wilayah: 'Desa/Kelurahan (83.763 Titik)', padanan: 'Eksekutor Lapangan — Ujung Tombak KOPNUSA', icon: Flag, color: '#7c3aed' },
];
...
const DEWAN_PENDIRI = [
  { id: 'pendiri1', no: 1, nama: 'Drs. H. Arif Rachman Hakim, M.M.', jabatan: 'Sekretaris Jenderal / CEO JE-P3', photo: '/images/people/sekjen.svg', tahun: '2029', status: 'Aktif', detailProfil: ['Ex. Komisaris Utama PT Aero Umroh Nusantara', 'Inisiator Architect Koperasi Nusa Berdikari Merah Putih', 'President Director Top Umroh', 'CEO PT Arofah Global Sistem'] },
...
const KOORDINATOR_KAWASAN = [
  ...
  { no: 3, kawasan: 'KALIMANTAN (Bakorwil Kalimantan)', panglima: 'Andi Darmadji, S.E. (Pendiri ke-15 KOPNUSA)', cakupan: 'Kalimantan Barat, Kalimantan Tengah, Kalimantan Selatan, Kalimantan Timur, Kalimantan Utara (5 Provinsi)', catatan: 'IKN Nusantara — Episentrum Baru | Sawit, Batubara, Rotan', status: 'terisi' },
...
const ROADMAP = [
  ...
  { fase: 'Fase 3 — RAT Perdana', timeline: '2026', target: 'Pengesahan Seluruh Pengurus melalui RAT Perdana KOPNUSA BERDIKARI' },
  ...
  return (
    <main className="min-h-screen bg-background">
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="space-y-6">
            <motion.div variants={fadeInUp}>
              <Badge variant="outline" className="border-[#008F3D] text-[#008F3D] px-5 py-2 bg-white/10 text-sm">
                📋 Dokumen Resmi KOPNUSA BERDIKARI
              </Badge>
            </motion.div>
      ...
      <section id="bab8" className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader bab="BAB VIII" title="Struktur Operasional" subtitle="17 Ketua Bidang Operasional — Pilar Eksekutif KOPNUSA BERDIKARI" badge="17 Bidang" badgeColor="#059669" />
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
            <Card className="overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-[#8B0000] to-[#6B0000] text-white">
                <CardTitle className="flex items-center gap-2"><TrendingUp className="w-5 h-5" /> Roadmap KOPNUSA BERDIKARI</CardTitle>
              </CardHeader>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <motion.h2 variants={fadeInUp} className="text-3xl font-bold text-white mb-6">
              Bergabung dengan <span className="text-[#00A847]">KOPNUSA BERDIKARI</span>
            </motion.h2>
