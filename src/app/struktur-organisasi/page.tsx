...
const DEWAN_PENDIRI = [
  {
    no: 1,
    nama: 'H. Arif Rachman Hakim, M.M.',
    jabatan: 'Wakil Presiden / CEO JE-P3',
    peran: 'Wakil Presiden / Wakil Ketua Umum, CEO JE-P3 & Diplomat Utama 195 Negara',
  },
  {
    no: 2,
    nama: 'Prof. Wirono, S.E., M.Pd',
    jabatan: 'Presiden / Ketua Umum (Bakornas)',
    peran: 'Presiden / Ketua Umum (Bakornas), Pimpinan Tertinggi Eksekutif KMNMP',
  },
  {
    no: 3,
    nama: 'Prof. Dr. Teddy Mantoro, MSC., PHD., SMIEEE',
    jabatan: 'Ketua Dewan Pengawas',
    peran: 'Ketua Dewan Pengawas, Ahli Tata Kelola Digital & CTO Advisor',
  },
  {
    no: 4,
    nama: 'Dr. Habib',
    jabatan: 'Anggota Dewan Pengawas',
    peran: 'Anggota Dewan Pengawas, Ahli Ketahanan Pangan Nasional',
  },
  {
    no: 5,
    nama: 'Komjen. Pol. (Purn.) Dr. Dharma Pongrekun',
    jabatan: 'Ketua Bidang Keamanan Siber',
    peran: 'Ketua Bidang Keamanan Siber & Kedaulatan Digital, Mantan Wakil Kepala BSSN',
  },
  {
    no: 6,
    nama: 'Dalam Proses Pengesahan',
    jabatan: 'Dewan Penasihat Pertahanan',
    peran: 'Dewan Penasihat Pertahanan & Ketahanan Nasional',
  },
  {
    no: 7,
    nama: 'Tn. H. Gugun Gunara, S.E., M.M.',
    jabatan: 'Grand Architect & COO',
    peran: 'Grand Architect & COO, Arsitek Ekosistem Digital KMNMP',
  },
  {
    no: 8,
    nama: 'Dr. Cecep Sumarno',
    jabatan: 'Sekretaris Jenderal',
    peran: 'Sekretaris Jenderal, Kepala Administrasi & Legal Koperasi',
  },
  {
    no: 9,
    nama: 'Andi Darmadji, S.E.',
    jabatan: 'Korwil Kalimantan (Bakorwil)',
    peran: 'Panglima Wilayah Kalimantan (Bakorwil), Pilar Ekspansi Kawasan Timur & IKN',
  },
  {
    no: 10,
    nama: 'Hj. Inna Hadianala, S.E.',
    jabatan: 'Ketua Bidang Organisasi & Keanggotaan',
    peran: 'Ketua Bidang Organisasi & Keanggotaan',
  },
  {
    no: 11,
    nama: 'Fawwaz Arif Al Jabar, S.E., M.M.',
    jabatan: 'Ketua Bidang Keuangan & Perbankan',
    peran: 'Ketua Bidang Keuangan & Perbankan, CFO & Chief Financial Advisor',
  },
  {
    no: 12,
    nama: 'H. Mugi Prasetyo, S.E.',
    jabatan: 'Koordinator Bidang Kemitraan Strategis',
    peran: 'Koordinator Bidang Kemitraan Strategis',
  },
  {
    no: 13,
    nama: 'Dr. N. Rusmiati, M.Si., M.H.',
    jabatan: 'Koordinator Bidang Pariwisata',
    peran: 'Ketua Umum DPP ASITA, Koordinator Bidang Pariwisata',
  },
  {
    no: 14,
    nama: 'Hj. Fani Anggraeni, S.E.',
    jabatan: 'Koordinator Bidang Pengembangan SDM',
    peran: 'Koordinator Bidang Pengembangan SDM',
  },
  {
    no: 15,
    nama: 'Ir. Endro Wuryanto, M.M.',
    jabatan: 'Koordinator Bidang Infrastruktur Digital',
    peran: 'Koordinator Bidang Infrastruktur Digital',
  },
  {
    no: 16,
    nama: 'Prof. Dr. H. Anwar Sanusi, SH, S.Pel, MM',
    jabatan: 'Wakil Ketua Dewan Pembina',
    peran: 'Wakil Ketua Dewan Pembina, Representasi Pemerintah',
  },
  {
    no: 17,
    nama: 'Dalam Proses Pengesahan',
    jabatan: 'Pendiri ke-17',
    peran: 'Menunggu Pengesahan RAT',
  },
];

// Dewan Pengawas
const DEWAN_PENGAWAS = [
  { jabatan: 'Ketua Dewan Pengawas', nama: 'Prof. Dr. Teddy Mantoro, MSC., PHD., SMIEEE', keterangan: 'Pendiri ke-3 | Independen', status: 'terisi' },
  { jabatan: 'Wakil Ketua Pengawas', nama: 'Prof. Dr. Elan Masbulan', keterangan: 'Pakar Pendidikan & Tata Kelola', status: 'terisi' },
  { jabatan: 'Sekretaris Pengawas', nama: 'Dr. Habib', keterangan: 'Pendiri ke-4 | Bidang Pangan', status: 'terisi' },
...
// Dewan Pembina
const DEWAN_PEMBINA = [
  { jabatan: 'Ketua Dewan Pembina', nama: '(Kosong — Usulan: Tokoh Senior)', keterangan: 'Dipilih melalui RAT', status: 'kosong' },
  { jabatan: 'Wakil Ketua Pembina', nama: '(Kosong — Usulan: Unsur Pemerintah)', keterangan: 'Representasi Pemerintah', status: 'kosong' },
...
// Presidium Eksekutif Nasional (BAKORNAS)
const PRESIDIUM_BAKORNAS = [
  { jabatan: 'PRESIDEN / Ketua Umum (Bakornas)', nama: 'Prof. Wirono, S.E., M.Pd', keterangan: 'Pendiri ke-2 | Pemimpin Tertinggi Eksekutif', status: 'terisi', highlight: true },
  { jabatan: 'WAKIL PRESIDEN / Wakil Ketua Umum', nama: 'H. Arif Rachman Hakim, M.M.', keterangan: 'Pendiri ke-1 | CEO JE-P3 & Diplomasi Global', status: 'terisi', highlight: true },
  { jabatan: 'SEKRETARIS JENDERAL (Sekjen)', nama: 'Dr. Cecep Sumarno', keterangan: 'Pendiri ke-8 | Legal Koperasi', status: 'terisi' },
  { jabatan: 'WAKIL SEKRETARIS JENDERAL (Wasekjen)', nama: 'Tn. H. Gugun Gunara', keterangan: 'Pendiri ke-7 | COO + Grand Architect KNMP', status: 'terisi', highlight: true },
...
// Koordinator 17 Bidang Strategis
const KOORDINATOR_BIDANG = [
  { no: 1, bidang: 'Bidang Organisasi & Keanggotaan', ketua: 'Hj. Inna Hadianala, S.E.', sekretaris: '(Kosong — Usulan: Ahli Manajemen SDM)', catatan: 'Pendiri ke-10 | Koordinator Organisasi', status: 'terisi' },
  { no: 2, bidang: 'Bidang Pangan & Ketahanan Pangan', ketua: 'Dr. Habib', sekretaris: '(Kosong — Usulan: Ahli Agribisnis/Pangan)', catatan: 'Pendiri ke-4 | Ketahanan Pangan Nasional', status: 'terisi' },
  ...
  { no: 6, bidang: 'Bidang Keuangan & Perbankan', ketua: 'Fawwaz Arif Al Jabar, S.E., M.M.', sekretaris: '(Kosong — Usulan: Ahli Perbankan Koperasi)', catatan: 'Pendiri ke-11 | CFO & Fintech Desa', status: 'terisi' },
  ...
  { no: 10, bidang: 'Bidang Holding Trading Ekosistem', ketua: 'Tn. H. Gugun Gunara, S. E', sekretaris: 'Cecep Abdul Jabbar', catatan: 'Pendiri ke-7 | Grand Architect | Holding Strategis', status: 'terisi' },
  { no: 11, bidang: 'Bidang Wisata, Umroh & Haji', ketua: 'Dr. Cecep Sumarno', sekretaris: '(Kosong — Usulan: Ahli Bisnis Haji/Umroh)', catatan: 'Pendiri ke-8 | Sekjen merangkap Bid. 11', status: 'terisi' },
  { no: 12, bidang: 'Bidang Hukum & Advokasi', ketua: 'Tegar Ramadhan, SH', sekretaris: '(Kosong — Usulan: Konsultan Hukum/Notaris)', catatan: 'Legal, Compliance, Advokasi Anggota', status: 'terisi' },
  { no: 13, bidang: 'Bidang Pengembangan SDM & Diklat', ketua: 'Dalam Proses Pengesahan', sekretaris: '(Kosong — Usulan: Trainer/HRD Bersertifikat)', catatan: 'JE-P3 Academy | Kader KNMP Nasional', status: 'terisi' },
  { no: 14, bidang: 'Bidang Ekspor Impor & Perdagangan Internasional', ketua: 'Dalam Proses Pengesahan', sekretaris: '(Kosong — Usulan: Ahli Kepabeanan/Logistik Ekspor)', catatan: 'Global Trade Desk | Komoditas Ekspor Desa', status: 'terisi' },
  { no: 15, bidang: 'Bidang Hubungan Masyarakat & Media', ketua: 'Dalam Proses Pengesahan', sekretaris: '(Kosong — Usulan: Jurnalis/Content Strategist)', catatan: 'Branding KNMP Nasional & Internasional', status: 'terisi' },
  { no: 16, bidang: 'Bidang Teknologi & Inovasi', ketua: 'Dalam Proses Pengesahan', sekretaris: '(Kosong)', catatan: 'IT Infrastructure | Software Development', status: 'terisi' },
  { no: 17, bidang: 'Bidang Kemitraan Internasional', ketua: 'Dalam Proses Pengesahan', sekretaris: '(Kosong)', catatan: 'Diplomasi Ekonomi | 195 Negara', status: 'terisi' },
];
...
const KOORDINATOR_KAWASAN = [
  ...
  { no: 3, kawasan: 'KALIMANTAN (Bakorwil Kalimantan)', panglima: 'Andi Darmadji, S.E. (Pendiri ke-9 KNMP)', cakupan: 'Kalimantan Barat, Kalimantan Tengah, Kalimantan Selatan, Kalimantan Timur, Kalimantan Utara (5 Provinsi)', catatan: 'IKN Nusantara — Episentrum Baru | Sawit, Batubara, Rotan', status: 'terisi' },
...
const REKAPITULASI = [
  ...
  { komponen: 'Koordinator 17 Bidang', status: 'LENGKAP', keterangan: '17 Ketua Terisi', color: 'green' },
  { komponen: 'Koordinator 5 Kawasan', status: '3/5 Terisi', keterangan: 'Jawa & Papua Kosong — Prioritas', color: 'yellow' },
];

// Roadmap
const ROADMAP = [
  { fase: 'Fase 0 — Pendirian', timeline: 'Maret 2026', target: '17 Pendiri ✅ | Presidium Inti ✅ | Akta Notaris' },
  { fase: 'Fase 1 — Konsolidasi', timeline: 'Maret 2026', target: 'Bendahara + 5 Bidang Prioritas + Bakorwil Jawa' },
  { fase: 'Fase 2 — Ekspansi Pulau', timeline: 'Maret 2026', target: '10 Bidang Tersisa + Bakorwil Papua + Sekretaris Bidang (17 Bidang Total)' },
  ...
  return (
    <section className="py-16 bg-muted/30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="text-center mb-10">
          <motion.div variants={fadeInUp}>
            <Badge className="bg-[#8B0000] text-white mb-3">17 Anggota Pendiri</Badge>
          </motion.div>
          <motion.h2 variants={fadeInUp} className="text-responsive-title font-bold mb-4">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {DEWAN_PENDIRI.map((pendiri) => {
            const isPending = pendiri.nama === 'Dalam Proses Pengesahan';
            return (
              <motion.div key={pendiri.no} variants={scaleIn}>
                <Card className={cn(
                  "h-full card-hover-lift",
                  isPending ? "border-amber-400 bg-amber-50/50" : "border-l-4 border-l-[#008F3D]"
                )}>
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      <div className={cn(
                        "w-10 h-10 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0",
                        isPending ? "bg-amber-500" : "bg-[#8B0000]"
                      )}>
                        {pendiri.no}
                      </div>
                      <div className="flex-1 min-w-0">
                        <h4 className={cn("font-semibold mb-1", isPending && "text-amber-700 italic")}>
                          {pendiri.nama}
                        </h4>
          ...
          <Card className="bg-green-50 dark:bg-green-950/20 border-green-200 dark:border-green-800">
            <CardContent className="p-4 flex gap-3">
              ...
              <p className="text-sm text-green-800 dark:text-green-200">
                <strong>LEGAL NOTE:</strong> 17 Pendiri (angka ganjil) memenuhi persyaratan quorum pengambilan keputusan dengan prinsip simple majority (9:8) maupun supermajority (12:5). Sesuai Permenkop 8/2021.
              </p>
            </CardContent>
          </Card>
        </motion.div>
  ...
  return (
    <section className="py-16 bg-background">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="text-center mb-10">
          <motion.div variants={fadeInUp}>
            <Badge className="bg-[#008F3D] text-[#1a1a2e] mb-3">17 Divisi Strategis</Badge>
          </motion.div>
          <motion.h2 variants={fadeInUp} className="text-responsive-title font-bold mb-4">
