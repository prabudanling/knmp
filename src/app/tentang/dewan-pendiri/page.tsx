...
// 17 Dewan Pendiri - KMN BERDIKARI BERDIKARI (Updated)
const DEWAN_PENDIRI = [
  { no: 1, name: 'Drs. H. Arif Rachman Hakim, M.M.', position: 'Pendiri ke-1', role: 'Sekretaris Jenderal / CEO NB, Inisiator Architect Koperasi Nusa Berdikari Merah Putih', kuadran: 'POLITIK' },
  ...
  { no: 7, name: 'H. Gugun Gunara, S.E.', position: 'Pendiri ke-7', role: 'Wakil Sekretaris Jenderal / Grand Architect & COO, Senior Konsultan Bisnis 16+ tahun, Arsitek Ekosistem Digital KMN BERDIKARI', kuadran: null },
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              <Badge className="bg-[#008F3D] text-white px-4 py-2 text-sm mb-4">
                ...
                17 Dewan Pendiri KMN BERDIKARI BERDIKARI
              </Badge>
            </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-8">
              ...
              <p className="text-white/60 text-sm">Membentuk pertahanan menyeluruh untuk KMN BERDIKARI BERDIKARI</p>
            </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-xl font-bold text-white mb-3">
              Bergabung dengan Ekosistem KMN BERDIKARI BERDIKARI
            </h2>
