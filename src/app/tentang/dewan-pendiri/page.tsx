...
const DEWAN_PENDIRI = [
  ...
  { no: 17, name: 'Dalam Proses Pengesahan', position: 'Pendiri ke-17', role: 'Menunggu Pengesahan RAT', kuadran: null },
];
...
const KORBID = [
  ...
  { no: 7, bidang: 'Investasi & ESG', ketua: '(RAT Perdana)', color: '#8b5cf6', isVacant: true },
