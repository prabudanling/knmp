...
const roadmapData = [
  {
    ...
    description: "1.000 desa pilot project, NB Pay & Marketplace live",
    target: "Pilot Phase",
    progress: 10,
    icon: Rocket,
...
const strategicPillars = [
  ...
  },
  {
    ...
    items: ["NB Pay", "Marketplace", "Logistik Digital", "Resi Gudang", "Kampung Modal", "Trading Internasional"],
    icon: Briefcase,
  },
  {
          ...
          >
            ...
            >
              ...
              >
                ...
                Visi & Misi KMN BERDIKARI — AD Versi 7
              </Badge>
            </motion.div>
            ...
            <h1 className="text-responsive-hero font-bold text-white mb-6">
              ...
              <br />
              <span className="text-white">KMN BERDIKARI</span>
            </h1>
          ...
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <h2 className="text-responsive-title font-bold mb-6">
                Visi <span className="text-gradient-primary">Utama</span> KMN BERDIKARI
              </h2>
            </div>
          </AnimatedSection>
            ...
            <Card className="max-w-5xl mx-auto mb-16 border-2 border-primary/20 overflow-hidden relative">
              ...
              <CardContent className="p-8 md:p-12 text-center">
                ...
                <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                  KMN BERDIKARI hadir sebagai platform ekonomi digital yang menghubungkan seluruh desa di Indonesia,
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <h2 className="text-responsive-title font-bold mb-6">
                4 Misi <span className="text-gradient-gold">Strategis</span> KMN BERDIKARI
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Langkah-langkah strategis untuk mewujudkan visi besar KMN BERDIKARI sebagai Digital Operating System Desa Indonesia
              </p>
            </div>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Fondasi pertahanan yang melindungi kedaulatan, keadilan, dan keberlanjutan ekosistem KMN BERDIKARI
              </p>
            </div>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Timeline strategis pertumbuhan KMN BERDIKARI dari pilot project hingga Digital Operating System Desa terbesar di dunia
              </p>
            </div>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <h2 className="text-responsive-title font-bold mb-6">
                Pilar <span className="text-gradient-gold">Strategis</span> KMN BERDIKARI
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Fondasi strategis yang mendukung pencapaian visi dan misi KMN BERDIKARI
              </p>
            </div>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Target ambisius yang akan dicapai KMN BERDIKARI pada tahun 2045
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
                Bergabunglah dengan KMN BERDIKARI untuk menjadi bagian dari transformasi ekonomi desa Indonesia
