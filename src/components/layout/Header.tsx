...
const menuStructure = [
  ...
  },
  {
    ...
    icon: Target,
    color: '#f59e0b',
    description: '9 Pilar Kampung',
    children: [
      { label: 'Kampung Pemerintahan Digital', href: '/pilar/kampung-digital', icon: Laptop, color: '#3b82f6', number: 1, badge: 'Adhikara Jnana' },
      { label: 'Kampung Modal', href: '/pilar/kampung-modal', icon: Scale, color: '#f59e0b', number: 2, badge: 'Adhikara Artha' },
      { label: 'Kampung Industri', href: '/pilar/kampung-industri', icon: Warehouse, color: '#8B0000', number: 3, badge: 'Adhikara Krada' },
      { label: 'Kampung Pangan', href: '/pilar/kampung-pangan', icon: Wheat, color: '#16a34a', number: 4, badge: 'Adhikara Anna' },
      { label: 'Kampung Sehat', href: '/pilar/kampung-sehat', icon: Heart, color: '#dc2626', number: 5, badge: 'Adhikara Roga' },
      { label: 'Kampung Cerdas', href: '/pilar/kampung-cerdas', icon: GraduationCap, color: '#7c3aed', number: 6, badge: 'Adhikara Vidya' },
      { label: 'Kampung Niaga', href: '/pilar/kampung-niaga', icon: Truck, color: '#0d9488', number: 7, badge: 'Adhikara Yana' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'NB Academy', href: '/academy', icon: GraduationCap, color: '#8b5cf6', badge: '3 Level' },
    ]
  },
]
...
const quickActions = [
  ...
  { label: '9 Pilar', href: '/smart-village', icon: Target, color: '#f59e0b' },
                          ...
                          <div className="bg-white/95 backdrop-blur-xl border border-gray-100 rounded-xl shadow-xl shadow-gray-900/10 p-2 overflow-hidden">
                            ...
                            {item.children.map((child, childIndex) => (
                              ...
                              >
                                ...
                                >
                                  {/* Numbered circle for 9 Pilar, icon for others */}
              ...
              <div className="p-4 pt-2 space-y-3">
                ...
                >
                  {[
                    ...
                    { value: '9', label: 'Pilar Utama', icon: Target },
