...
import {
  ...
  Users, Sparkles, Heart,
  Globe, MapPin,
  ArrowRight,
  MessageCircle, Phone,
  Landmark, Briefcase,
  Crown, Map, Target, Scale, Wheat, Warehouse,
  User, Laptop, Package,
} from 'lucide-react'
...
const menuStructure = [
  ...
  {
    label: 'Nusa Futuristik',
    href: '/nusa-futuristik',
    icon: Sparkles,
    color: '#8B0000',
    description: 'Indonesia 2045',
    children: [
      { label: 'Provinsi Futuristik', href: '/nusa-futuristik/provinsi', icon: Landmark, color: '#008F3D', badge: '38' },
  ...
  },
  {
    ...
    icon: Target,
    color: '#f59e0b',
    description: 'Pilar Transformasi',
    children: [
      { label: 'Pemerintahan & Bisnis Center', href: '/nusa-futuristik/provinsi/proyek-strategis', icon: Building2, color: '#008F3D', number: 1 },
      { label: 'Proyek Strategis & Kawasan Industri', href: '/nusa-futuristik/provinsi/kawasan-industri-terpadu', icon: Warehouse, color: '#8B0000', number: 2 },
      { label: 'Kampung Modal / DIPUNTARA', href: '/nusa-futuristik/provinsi/kampung-modal', icon: Scale, color: '#f59e0b', number: 3, badge: 'NEW' },
      { label: 'Kawasan Pangan Terpadu', href: '/nusa-futuristik/provinsi/kawasan-pangan-terpadu', icon: Wheat, color: '#16a34a', number: 4 },
      { label: 'Kesehatan, Olahraga & Wisata', href: '/nusa-futuristik/provinsi/wisata-terpadu', icon: Heart, color: '#dc2626', number: 5 },
      { label: 'Transportasi & Logistik Digital', href: '/nusa-futuristik/provinsi/transportasi-digital', icon: Truck, color: '#0d9488', number: 6 },
      { label: 'Rumah Produktif', href: '/nusa-futuristik/provinsi/rumah-produktif', icon: Home, color: '#92400e', number: 7, badge: 'NEW' },
    ]
  },
  {
    label: 'Pimpinan',
...
const quickActions = [
  ...
  { label: '7 Pilar', href: '/nusa-futuristik/provinsi/kampung-modal', icon: Target, color: '#f59e0b' },
                      ...
                      {activeDropdown === item.label && (
                        <motion.div
                          ...
                          className={cn(
                            ...
                            item.label === '7 Pilar' ? "min-w-[320px]" : "min-w-[220px]"
                          )}
                        >
                          <div className="bg-white/95 backdrop-blur-xl border border-gray-100 rounded-xl shadow-xl shadow-gray-900/10 p-2 overflow-hidden">
                            ...
                            {item.label === '7 Pilar' && (
                              <div className="px-4 py-2.5 border-b border-gray-100 mb-1">
                                <p className="text-[10px] font-bold text-[#f59e0b] uppercase tracking-widest">7 Pilar Transformasi</p>
                                <p className="text-[10px] text-gray-400 mt-0.5">Pilar Pembangunan Peradaban Desa Digital</p>
                              </div>
                            )}
                            {item.children.map((child, childIndex) => (
                              ...
                              >
                                ...
                                >
                                  {/* Numbered circle for 7 Pilar, icon for others */}
                                  {'number' in child && child.number !== undefined ? (
                                    <div
                                    ...
                                    <child.icon className="w-4 h-4 shrink-0" style={{ color: child.color }} />
                                  )}
                                  <span className="flex-1">{child.label}</span>
                                  {child.badge && (
                                    <Badge className={cn(
                                      "text-[10px] px-1.5 py-0.5 text-white border-0",
                                      child.badge === 'NEW'
                                        ? "bg-gradient-to-r from-[#f59e0b] to-[#d97706]"
                                        : "bg-gradient-to-r from-[#008F3D] to-[#8B0000]"
                                    )}>
                                      {child.badge}
                                    </Badge>
                                  )}
          ...
          >
            ...
            >
                      ...
                      <div className="rounded-xl overflow-hidden">
                        ...
                        <AnimatePresence>
                          {expandedMobile === item.label && (
                            ...
                            >
                              {/* 7 Pilar header in mobile */}
                              {item.label === '7 Pilar' && (
                                <div className="pl-4 pr-2 pt-2 pb-1">
                                  <p className="text-[10px] font-bold text-[#f59e0b] uppercase tracking-widest px-4">7 Pilar Transformasi</p>
                                </div>
                              )}
                                ...
                                {item.children.map((child, ci) => (
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      {child.badge && (
                                        <Badge className={cn(
                                          "text-[9px] px-1.5 py-0.5 text-white border-0",
                                          child.badge === 'NEW'
                                            ? "bg-gradient-to-r from-[#f59e0b] to-[#d97706]"
                                            : "bg-gradient-to-r from-[#008F3D] to-[#8B0000]"
                                        )}>
              ...
              <div className="p-4 pt-2 space-y-3">
                ...
                >
                  {[
                    { value: '92.269', label: 'Desa/Kel', icon: Building2 },
                    { value: '7', label: 'Pilar Utama', icon: Target },
