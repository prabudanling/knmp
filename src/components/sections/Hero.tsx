      ...
      >
        ...
        >
          ...
          >
            ...
            <motion.h1
              variants={fadeInUp}
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-[#1A1A1A] leading-[1.1] tracking-tight text-center"
            >
              <span className="block text-[#008F3D]">VISI DESA DIGITAL FUTURISTIK</span>
              <span className="block text-[#8B0000]">TERINTEGRASI NASIONAL 2028</span>
            </motion.h1>

            {/* Sub-headline - Management Koperasi */}
            <motion.p
              variants={fadeInUp}
              className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-center mt-3 sm:mt-4 px-2"
            >
              <span className="text-[#008F3D]">
                MANAGEMEN KOPERASI KORPORASI MULTIPIHAK
              </span>
            ...
            {/* Tagline - Transformasi Ekosistem */}
            <motion.p
              variants={fadeInUp}
              className="text-xs sm:text-sm md:text-base lg:text-lg font-semibold text-center mt-2 sm:mt-3 px-2 text-[#374151]"
            >
              TRANSFORMASI EKOSISTEM DESA MANDIRI{' '}
              <span className="text-[#008F3D] font-bold">PANGAN</span>{'.'}{' '}
              <span className="text-[#8B0000] font-bold">ENERGI</span>{'.'}{' '}
              <span className="text-[#008F3D] font-bold">KESEHATAN</span>{' '} dan{' '}
              <span className="text-[#8B0000] font-bold">TRANSPORTASI</span>
            </motion.p>
