...
export const KPA_COLORS = {
  KPA_1_PETANI_PRODUSEN: '#008F3D',    // Green - Petani/Produsen
  KPA_2_PENGUSAHA_PENGEPUL: '#f59e0b', // Amber - Pengusaha/Pengepul
  KPA_3_KOPERASI_BUMDES: '#8B0000',    // Dark Red - Koperasi/BUMDes
  KPA_4_PEKERJA_KADER: '#7c3aed',      // Purple - Pekerja/Kader
  KPA_5_KONSUMEN: '#0ea5e9',           // Sky Blue - Konsumen
};
