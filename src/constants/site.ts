...
export const SITE_CONFIG = {
  ...
  // SEO
  seo: {
    title: 'KOPNUSA - Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih | Digital OS Desa Indonesia',
    description: 'Portal resmi Koperasi Korporasi Multipihak Nusa Berdikari Merah Putih (KKMNMP/KNMP). Mengintegrasikan 83.763 desa, 5 Kelompok Pihak Anggota (KPA), marketplace zonasi, logistik digital, dan smart village dashboard.',
    keywords: [
