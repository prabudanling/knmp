...
export const GOVERNANCE_STRUCTURE: GovernanceStructure = {
  pengurus: [
    ...
    { id: 'p3', name: 'Drs. H. Arif Rachman Hakim, M.M.', position: 'Sekretaris Jenderal / CEO JE-P3', photo: '/images/people/sekjen.svg', termStart: '2029', termEnd: '2032' },
...
export const DEWAN_PENDIRI = [
  { id: 'pendiri-1', no: 1, name: 'Drs. H. Arif Rachman Hakim, M.M.', position: 'Pendiri ke-1', role: 'Sekretaris Jenderal / CEO JE-P3, Inisiator Architect Koperasi Nusa Berdikari Merah Putih', status: 'active' },
...
export const TEAM_STRUCTURE = {
  pengurus: [
    ...
    { id: 'p3', name: 'Drs. H. Arif Rachman Hakim, M.M.', position: 'Sekretaris Jenderal / CEO JE-P3', photo: '/images/people/sekjen.svg', termStart: '2029', termEnd: '2032', bio: 'Inisiator Architect Koperasi Nusa Berdikari Merah Putih, President Director Top Umroh' },
...
export const KORNAS_STRUCTURE = {
  ...
  structure: [
    // Dewan Pendiri (17 Anggota) - Urutan Sesuai KOPNUSA BERDIKARI 2029
    {
      ...
      positions: [
        { id: 'dp-1', position: 'Pendiri ke-1 — Sekretaris Jenderal / CEO JE-P3', name: 'Drs. H. Arif Rachman Hakim, M.M.', status: 'filled' as const, termEnd: '2029' },
    ...
    // Pengurus Harian Nasional
    {
      ...
      positions: [
        ...
        { id: 'phn-3', position: 'Sekretaris Jenderal / CEO JE-P3', name: 'Drs. H. Arif Rachman Hakim, M.M.', status: 'filled' as const, termEnd: '2029' },
...
export const DEWAN_PENDIRI_LENGKAP = [
  { id: 'pendiri-1', name: 'Drs. H. Arif Rachman Hakim, M.M.', position: 'Pendiri ke-1 — Sekretaris Jenderal / CEO JE-P3', role: 'Inisiator Architect Koperasi Nusa Berdikari Merah Putih, President Director Top Umroh', status: 'filled' as const },
