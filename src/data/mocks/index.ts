...
export const KPA_DATA: KPACategory[] = [
  {
    id: 'KPA_1_PETANI_PRODUSEN',
    name: 'Petani/Produsen',
    description: 'Petani, nelayan, pengrajin, peternak, pekebun — pencipta nilai utama ekosistem',
    icon: 'Wheat',
    color: '#008F3D',
    votingPower: 30,
    memberCount: 50000,
  ...
  {
    id: 'KPA_2_PENGUSAHA_PENGEPUL',
    name: 'Pengusaha/Pengepul',
    description: 'Pedagang, pengepul, eksportir, UMKM, aggregator — penghubung pasar dan distribusi',
    icon: 'Store',
    color: '#f59e0b',
    votingPower: 20,
    memberCount: 25000,
  ...
  {
    id: 'KPA_3_KOPERASI_BUMDES',
    name: 'Koperasi/BUMDes',
    description: 'KDMP, BUMDesMA, KUD, koperasi primer — entitas koperasi dan badan usaha desa',
    icon: 'Building2',
    color: '#8B0000',
    votingPower: 20,
    memberCount: 12000,
  ...
  {
    id: 'KPA_4_PEKERJA_KADER',
    name: 'Pekerja/Kader',
    description: 'Pegawai, agen logistik, kader digital, pekerja operasional — tulang punggung operasional',
    icon: 'Users',
    color: '#7c3aed',
    votingPower: 15,
    memberCount: 28000,
  },
  {
    id: 'KPA_5_KONSUMEN',
    name: 'Konsumen',
    description: 'Anggota konsumen, pengguna akhir, pembeli retail — mesin permintaan pasar',
    icon: 'ShoppingCart',
    color: '#0ea5e9',
    votingPower: 15,
    memberCount: 10000,
...
export const SHU_BREAKDOWN: SHUBreakdown = {
  ...
  memberDistribution: [
    { kpa: 'KPA_1_PETANI_PRODUSEN', totalJasaUsaha: 2250000000, totalJasaModal: 500000000, memberCount: 50000 },
    { kpa: 'KPA_2_PENGUSAHA_PENGEPUL', totalJasaUsaha: 1250000000, totalJasaModal: 300000000, memberCount: 25000 },
    { kpa: 'KPA_3_KOPERASI_BUMDES', totalJasaUsaha: 1000000000, totalJasaModal: 250000000, memberCount: 12000 },
    { kpa: 'KPA_4_PEKERJA_KADER', totalJasaUsaha: 750000000, totalJasaModal: 150000000, memberCount: 28000 },
    { kpa: 'KPA_5_KONSUMEN', totalJasaUsaha: 375000000, totalJasaModal: 50000000, memberCount: 10000 },
  ],
};
...
export const GOVERNANCE_STRUCTURE: GovernanceStructure = {
  pengurus: [
    { id: 'p1', name: 'Dr. N. Rusmiati, M.Si., M.H.', position: 'Presiden / Ketua Umum', photo: '/images/people/ketua.svg', termStart: '2029', termEnd: '2032' },
    { id: 'p2', name: 'Prof. Wirono, S.E., M.Pd.', position: 'Wakil Ketua Umum', photo: '/images/people/waketum.svg', termStart: '2029', termEnd: '2032' },
    { id: 'p3', name: 'Drs. H. Arif Rachman Hakim, M.M.', position: 'Sekretaris Jenderal / CEO NB', photo: '/images/people/sekjen.svg', termStart: '2029', termEnd: '2032' },
    { id: 'p4', name: 'H. Gugun Gunara, S.E.', position: 'Wakil Sekretaris Jenderal / Grand Architect & COO', photo: '/images/people/wasekjen.svg', termStart: '2029', termEnd: '2032' },
    { id: 'p5', name: '(Belum Terisi)', position: 'Bendahara Umum', photo: '', termStart: '2029', termEnd: '2032' },
  ],
  pengawas: [
    { id: 'pw1', name: 'Prof. Dr. Elan Masbulan', position: 'Ketua Dewan Pengawas', photo: '/images/people/pengawas1.svg', termStart: '2029', termEnd: '2032' },
    { id: 'pw2', name: 'Dr. Habib', position: 'Anggota Dewan Pengawas', photo: '/images/people/pengawas2.svg', termStart: '2029', termEnd: '2032' },
  ],
  dewanPenasihat: [
    { id: 'dp1', name: 'Prof. Dr. H. Anwar Sanusi, S.H., S.Pel., M.M.', position: 'Ketua Dewan Penasehat', photo: '/images/people/penasihat1.svg', termStart: '2029', termEnd: '2032' },
    { id: 'dp2', name: 'Dr. Heri Solahudin', position: 'Anggota Dewan Penasehat', photo: '/images/people/penasihat2.svg', termStart: '2029', termEnd: '2032' },
  ],
  dewanEtik: [],
  ombudsman: [],
};
...
export const DEWAN_PENDIRI = [
  { id: 'pendiri-1', no: 1, name: 'Drs. H. Arif Rachman Hakim, M.M.', position: 'Pendiri ke-1', role: 'Sekretaris Jenderal / CEO NB, Inisiator Architect Koperasi Nusa Berdikari Merah Putih', status: 'active' },
  { id: 'pendiri-2', no: 2, name: 'Dr. N. Rusmiati, M.Si., M.H.', position: 'Pendiri ke-2', role: 'Presiden / Ketua Umum, Ketua Umum DPP ASITA 2019–2029', status: 'active' },
  { id: 'pendiri-3', no: 3, name: 'Prof. Wirono, S.E., M.Pd.', position: 'Pendiri ke-3', role: 'Wakil Ketua Umum, Mantan Marketing AJB Bumi Putera', status: 'active' },
  { id: 'pendiri-4', no: 4, name: 'Prof. Dr. Elan Masbulan', position: 'Pendiri ke-4', role: 'Ketua Dewan Pengawas, Akademisi/Peneliti bidang pertanian UGM', status: 'active' },
  { id: 'pendiri-5', no: 5, name: 'Prof. Dr. H. Anwar Sanusi, S.H., S.Pel., M.M.', position: 'Pendiri ke-5', role: 'Ketua Dewan Penasehat, Mantan Sekjen Kementerian Ketenagakerjaan RI', status: 'active' },
  { id: 'pendiri-6', no: 6, name: 'Prof. Dr. Teddy Mantoro, M.Sc., Ph.D., SMIEEE', position: 'Pendiri ke-6', role: 'Ketua Dewan Pakar, Director School of CS Nusa Putra University, Senior Member IEEE', status: 'active' },
  { id: 'pendiri-7', no: 7, name: 'H. Gugun Gunara, S.E.', position: 'Pendiri ke-7', role: 'Wakil Sekretaris Jenderal / Grand Architect & COO, Senior Konsultan 16+ tahun', status: 'active' },
  { id: 'pendiri-8', no: 8, name: 'Komjen. Pol. (Purn.) Dharma Pongrekun', position: 'Pendiri ke-8', role: 'Ketua Bidang Keamanan Siber, Mantan Wakil Kepala BSSN 2019–2021', status: 'active' },
  { id: 'pendiri-9', no: 9, name: 'Mayor Art. (Purn.) Cecep Sumarno, S.I.P., S.H.', position: 'Pendiri ke-9', role: 'Ketua Bidang Hukum dan Advokasi, Pengacara aktif', status: 'active' },
  { id: 'pendiri-10', no: 10, name: 'Dr. Habib', position: 'Pendiri ke-10', role: 'Anggota Dewan Pengawas, Pakar ketahanan pangan, Ketua Umum Asosiasi Pertanian', status: 'active' },
  { id: 'pendiri-11', no: 11, name: 'Dr. Heri Solahudin', position: 'Pendiri ke-11', role: 'Anggota Dewan Penasehat, Peneliti Senior CSEAS Kyoto University', status: 'active' },
  { id: 'pendiri-12', no: 12, name: 'Ir. Endro Wuryanto, M.M.', position: 'Pendiri ke-12', role: 'Koordinator Bidang Infrastruktur Digital', status: 'active' },
  { id: 'pendiri-13', no: 13, name: 'Sae Tanangga Karim, S.E.', position: 'Pendiri ke-13', role: 'Koordinator Bidang Event Organizer, General Manager PT Dyandra Promosindo', status: 'active' },
  { id: 'pendiri-14', no: 14, name: 'Hj. Inna Hadianala, S.E.', position: 'Pendiri ke-14', role: 'Koordinator Bidang Pengembangan SDM & Organisasi, Ex. Anggota DPRD Prov. Jawa Tengah', status: 'active' },
  { id: 'pendiri-15', no: 15, name: 'Andi Darmadji, S.E.', position: 'Pendiri ke-15', role: 'Koordinator Wilayah Kalimantan, Pilar Ekspansi Kawasan Timur & IKN', status: 'active' },
  { id: 'pendiri-16', no: 16, name: 'Posisi Belum Terisi', position: 'Pendiri ke-16', role: 'Menunggu Pengesahan', status: 'vacant' },
  { id: 'pendiri-17', no: 17, name: 'dr. Hanson Barki', position: 'Pendiri ke-17', role: 'Koordinator Bidang Adab dan Budaya, Dokter, Komisaris Utama PT Hanara Batik', status: 'active' },
];
...
export const KOORDINATOR_BIDANG = [
  { no: 1, bidang: 'Organisasi & Keanggotaan', ketua: 'Hj. Inna Hadianala, S.E.', sekretaris: '(Kosong)', catatan: 'Pendiri ke-14 | Koordinator Bidang Pengembangan SDM & Organisasi | Ex. Anggota DPRD Prov. Jawa Tengah' },
  { no: 2, bidang: 'Pangan & Ketahanan Pangan', ketua: 'Dr. Habib', sekretaris: '(Kosong)', catatan: 'Pendiri ke-10 | Anggota Dewan Pengawas' },
  { no: 3, bidang: 'Industri & Manufaktur', ketua: '(RAT Perdana)', sekretaris: '(Kosong)', catatan: 'Vacant — Akan diisi melalui RAT Perdana' },
  { no: 4, bidang: 'Logistik & Distribusi', ketua: 'M. Ilham', sekretaris: '(Kosong)', catatan: 'Jaringan Logistik 83.763 Desa' },
  { no: 5, bidang: 'Kesehatan & Farmasi', ketua: '(RAT Perdana)', sekretaris: '(Kosong)', catatan: 'Vacant — Akan diisi melalui RAT Perdana' },
  { no: 6, bidang: 'Keuangan & Perbankan', ketua: 'Fawwaz Arif Al Jabar, S.E., M.M.', sekretaris: '(Kosong)', catatan: 'CFO & ESG Architect' },
  { no: 7, bidang: 'Holding Trading Ekosistem', ketua: 'H. Gugun Gunara, S.E.', sekretaris: '(Kosong)', catatan: 'Pendiri ke-7 | Wakil Sekretaris Jenderal / Grand Architect & COO' },
  ...
  { no: 10, bidang: 'Adab & Budaya', ketua: 'dr. Hanson Barki', sekretaris: '(Kosong)', catatan: 'Pendiri ke-17 | Koordinator Bidang Adab dan Budaya' },
  { no: 11, bidang: 'Hukum & Advokasi', ketua: 'Mayor Art. (Purn.) Cecep Sumarno, S.I.P., S.H.', sekretaris: '(Kosong)', catatan: 'Pendiri ke-9 | Ketua Bidang Hukum dan Advokasi' },
  { no: 12, bidang: 'Haji dan Umroh', ketua: 'H. Abu Bakar', sekretaris: '(Kosong)', catatan: 'Layanan Haji & Umroh Anggota' },
  { no: 13, bidang: 'Pengembangan SDM & Diklat', ketua: '(Dalam Proses Pengesahan)', sekretaris: '(Kosong)', catatan: 'Dalam Proses Pengesahan' },
  { no: 14, bidang: 'Ekspor Impor & Perdagangan Internasional', ketua: '(Dalam Proses Pengesahan)', sekretaris: '(Kosong)', catatan: 'Dalam Proses Pengesahan' },
  { no: 15, bidang: 'Hubungan Masyarakat & Media', ketua: '(Dalam Proses Pengesahan)', sekretaris: '(Kosong)', catatan: 'Dalam Proses Pengesahan' },
  { no: 16, bidang: 'Teknologi & Inovasi', ketua: '(Dalam Proses Pengesahan)', sekretaris: '(Kosong)', catatan: 'Dalam Proses Pengesahan' },
  { no: 17, bidang: 'Kemitraan Internasional', ketua: '(Dalam Proses Pengesahan)', sekretaris: '(Kosong)', catatan: 'Dalam Proses Pengesahan' },
];
...
export const TEAM_STRUCTURE = {
  ...
  pengawas: [
    ...
    { id: 'pw2', name: 'Dr. Habib', position: 'Anggota Dewan Pengawas', photo: '/images/people/pengawas2.svg', termStart: '2029', termEnd: '2032', bio: 'Pakar di bidang ketahanan pangan, Ketua Umum Asosiasi Pertanian' },
  ],
  dewanPenasihat: [
    { id: 'dp1', name: 'Prof. Dr. H. Anwar Sanusi, S.H., S.Pel., M.M.', position: 'Ketua Dewan Penasehat', photo: '/images/people/penasihat1.svg', termStart: '2029', termEnd: '2032', bio: 'Mantan Sekjen Kementerian Ketenagakerjaan RI, Guru Besar Universitas Brawijaya' },
    { id: 'dp2', name: 'Dr. Heri Solahudin', position: 'Anggota Dewan Penasehat', photo: '/images/people/penasihat2.svg', termStart: '2029', termEnd: '2032', bio: 'Peneliti Senior CSEAS Kyoto University, Penulis "The Roots of ISIS in Indonesia"' },
  ],
  dewanPembina: [
    { id: 'dpm1', name: 'Dr. Ferry Juliantono, S.E., Ak., M.Si.', position: 'Menteri Koperasi', photo: '/images/people/pembina.svg', termStart: '2029', termEnd: '—', bio: 'Menteri Koperasi Republik Indonesia (sejak 2025)' },
    { id: 'dpm2', name: 'Widiyanti Putri Wardhana, B.Sc.', position: 'Menteri Pariwisata', photo: '/images/people/pembina2.svg', termStart: '2029', termEnd: '—', bio: 'Menteri Pariwisata RI (Kabinet Merah Putih), Co-founder Teladan Group' },
    { id: 'dpm3', name: 'Jenderal TNI (Purn.) Dr. H. Moeldoko, S.I.P.', position: 'Mantan Panglima TNI', photo: '/images/people/pembina3.svg', termStart: '2029', termEnd: '—', bio: 'Mantan Panglima TNI (2013–2015), Mantan Kepala Staf Kepresidenan' },
    { id: 'dpm4', name: 'Dr. H. Sandiaga Salahuddin Uno, B.B.A., M.B.A.', position: 'Mantan Menparekraf & Pengusaha', photo: '/images/people/pembina4.svg', termStart: '2029', termEnd: '—', bio: 'Pendiri Saratoga Capital, Mantan Wakil Gubernur DKI Jakarta' },
    { id: 'dpm5', name: 'Drs. Teten Masduki', position: 'Mantan Menteri Koperasi & UMKM', photo: '/images/people/pembina5.svg', termStart: '2029', termEnd: '—', bio: 'Pendiri Transparency International Indonesia, Koordinator ICW' },
    { id: 'dpm6', name: 'Dr. A. Iskandar Zulkarnain', position: 'Mantan Kepala LIPI', photo: '/images/people/pembina6.svg', termStart: '2029', termEnd: '—', bio: 'Mantan Kepala LIPI, Profesor Riset Bidang Geologi dan Geofisika' },
  ],
};
...
export const KORNAS_STRUCTURE = {
  ...
  structure: [
    // Dewan Pendiri (17 Anggota) - Urutan Sesuai KOPNUSA BERDIKARI 2029
    {
      ...
      positions: [
        { id: 'dp-1', position: 'Pendiri ke-1 — Sekretaris Jenderal / CEO NB', name: 'Drs. H. Arif Rachman Hakim, M.M.', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-2', position: 'Pendiri ke-2 — Presiden / Ketua Umum (Bakornas)', name: 'Dr. N. Rusmiati, M.Si., M.H.', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-3', position: 'Pendiri ke-3 — Wakil Ketua Umum', name: 'Prof. Wirono, S.E., M.Pd.', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-4', position: 'Pendiri ke-4 — Ketua Dewan Pengawas', name: 'Prof. Dr. Elan Masbulan', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-5', position: 'Pendiri ke-5 — Ketua Dewan Penasehat', name: 'Prof. Dr. H. Anwar Sanusi, S.H., S.Pel., M.M.', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-6', position: 'Pendiri ke-6 — Ketua Dewan Pakar', name: 'Prof. Dr. Teddy Mantoro, M.Sc., Ph.D., SMIEEE', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-7', position: 'Pendiri ke-7 — Wakil Sekretaris Jenderal / Grand Architect & COO', name: 'H. Gugun Gunara, S.E.', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-8', position: 'Pendiri ke-8 — Ketua Bidang Keamanan Siber', name: 'Komjen. Pol. (Purn.) Dharma Pongrekun', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-9', position: 'Pendiri ke-9 — Ketua Bidang Hukum dan Advokasi', name: 'Mayor Art. (Purn.) Cecep Sumarno, S.I.P., S.H.', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-10', position: 'Pendiri ke-10 — Anggota Dewan Pengawas', name: 'Dr. Habib', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-11', position: 'Pendiri ke-11 — Anggota Dewan Penasehat', name: 'Dr. Heri Solahudin', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-12', position: 'Pendiri ke-12 — Koordinator Bidang Infrastruktur Digital', name: 'Ir. Endro Wuryanto, M.M.', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-13', position: 'Pendiri ke-13 — Koordinator Bidang Event Organizer', name: 'Sae Tanangga Karim, S.E.', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-14', position: 'Pendiri ke-14 — Koordinator Bidang Pengembangan SDM & Organisasi, Ex. Anggota DPRD Prov. Jawa Tengah', name: 'Hj. Inna Hadianala, S.E.', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-15', position: 'Pendiri ke-15 — Koordinator Wilayah Kalimantan', name: 'Andi Darmadji, S.E.', status: 'filled' as const, termEnd: '2029' },
        { id: 'dp-16', position: 'Pendiri ke-16 — (Posisi Belum Terisi)', name: '(Posisi Belum Terisi)', status: 'pending' as const },
        { id: 'dp-17', position: 'Pendiri ke-17 — Koordinator Bidang Adab dan Budaya', name: 'dr. Hanson Barki', status: 'filled' as const, termEnd: '2029' },
      ]
    },
    // Dewan Pembina - 6 Anggota Prominan
    {
      category: 'Dewan Pembina',
      positions: [
        { id: 'dpm-1', position: 'Menteri Koperasi RI', name: 'Dr. Ferry Juliantono, S.E., Ak., M.Si.', status: 'filled' as const, termEnd: '—' },
        { id: 'dpm-2', position: 'Menteri Pariwisata RI', name: 'Widiyanti Putri Wardhana, B.Sc.', status: 'filled' as const, termEnd: '—' },
        { id: 'dpm-3', position: 'Mantan Panglima TNI', name: 'Jenderal TNI (Purn.) Dr. H. Moeldoko, S.I.P.', status: 'filled' as const, termEnd: '—' },
        { id: 'dpm-4', position: 'Mantan Menparekraf & Pengusaha', name: 'Dr. H. Sandiaga Salahuddin Uno, B.B.A., M.B.A.', status: 'filled' as const, termEnd: '—' },
        { id: 'dpm-5', position: 'Mantan Menteri Koperasi & UMKM', name: 'Drs. Teten Masduki', status: 'filled' as const, termEnd: '—' },
        { id: 'dpm-6', position: 'Mantan Kepala LIPI', name: 'Dr. A. Iskandar Zulkarnain', status: 'filled' as const, termEnd: '—' },
      ]
    },
    // Pengurus Harian Nasional
    {
      ...
      positions: [
        { id: 'phn-1', position: 'Presiden / Ketua Umum', name: 'Dr. N. Rusmiati, M.Si., M.H.', status: 'filled' as const, termEnd: '2029' },
        { id: 'phn-2', position: 'Wakil Ketua Umum', name: 'Prof. Wirono, S.E., M.Pd.', status: 'filled' as const, termEnd: '2029' },
        { id: 'phn-3', position: 'Sekretaris Jenderal / CEO NB', name: 'Drs. H. Arif Rachman Hakim, M.M.', status: 'filled' as const, termEnd: '2029' },
        { id: 'phn-4', position: 'Wakil Sekretaris Jenderal / Grand Architect & COO', name: 'H. Gugun Gunara, S.E.', status: 'filled' as const, termEnd: '2029' },
        { id: 'phn-5', position: 'Bendahara Umum', name: 'Belum terisi', status: 'pending' as const },
      ]
    },
    // Dewan Pengawas
    {
      ...
      positions: [
        { id: 'pw-1', position: 'Ketua Dewan Pengawas', name: 'Prof. Dr. Elan Masbulan', status: 'filled' as const, termEnd: '2029' },
        { id: 'pw-2', position: 'Anggota Dewan Pengawas', name: 'Dr. Habib', status: 'filled' as const, termEnd: '2029' },
      ]
    },
    // Dewan Pakar
    {
      ...
      positions: [
        { id: 'pk-1', position: 'Ketua Dewan Pakar', name: 'Prof. Dr. Teddy Mantoro, M.Sc., Ph.D., SMIEEE', status: 'filled' as const, termEnd: '2029' },
      ]
    },
    // Dewan Penasehat
    {
      ...
      positions: [
        { id: 'pn-1', position: 'Ketua Dewan Penasehat', name: 'Prof. Dr. H. Anwar Sanusi, S.H., S.Pel., M.M.', status: 'filled' as const, termEnd: '2029' },
        { id: 'pn-2', position: 'Anggota Dewan Penasehat', name: 'Dr. Heri Solahudin', status: 'filled' as const, termEnd: '2029' },
      ]
    },
    // Koordinator 17 Bidang
    {
      ...
      positions: [
        { id: 'kb-1', position: 'Bidang Organisasi & Keanggotaan', name: 'Hj. Inna Hadianala, S.E.', status: 'filled' as const, termEnd: '2029', bio: 'Ex. Anggota DPRD Prov. Jawa Tengah' },
        { id: 'kb-2', position: 'Bidang Pangan & Ketahanan Pangan', name: 'Dr. Habib', status: 'filled' as const, termEnd: '2029' },
        { id: 'kb-3', position: 'Bidang Industri & Manufaktur', name: '(RAT Perdana)', status: 'pending' as const },
        { id: 'kb-4', position: 'Bidang Logistik & Distribusi', name: 'M. Ilham', status: 'filled' as const, termEnd: '2029' },
        { id: 'kb-5', position: 'Bidang Kesehatan & Farmasi', name: '(RAT Perdana)', status: 'pending' as const },
        { id: 'kb-6', position: 'Bidang Keuangan & Perbankan', name: 'Fawwaz Arif Al Jabar, S.E., M.M.', status: 'filled' as const, termEnd: '2029' },
        { id: 'kb-7', position: 'Bidang Holding Trading Ekosistem', name: 'H. Gugun Gunara, S.E.', status: 'filled' as const, termEnd: '2029' },
        ...
        { id: 'kb-10', position: 'Bidang Adab & Budaya', name: 'dr. Hanson Barki', status: 'filled' as const, termEnd: '2029' },
        { id: 'kb-11', position: 'Bidang Hukum & Advokasi', name: 'Mayor Art. (Purn.) Cecep Sumarno, S.I.P., S.H.', status: 'filled' as const, termEnd: '2029' },
        { id: 'kb-12', position: 'Bidang Haji dan Umroh', name: 'H. Abu Bakar', status: 'filled' as const, termEnd: '2029' },
    ...
    // Sekretaris Masing-masing Bidang
    {
      ...
      positions: [
        { id: 'sk-1', position: 'Sekretaris Bidang Organisasi & Keanggotaan', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-2', position: 'Sekretaris Bidang Pangan & Ketahanan Pangan', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-3', position: 'Sekretaris Bidang Industri & Manufaktur', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-4', position: 'Sekretaris Bidang Logistik & Distribusi', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-5', position: 'Sekretaris Bidang Kesehatan & Farmasi', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-6', position: 'Sekretaris Bidang Keuangan & Perbankan', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-7', position: 'Sekretaris Bidang Holding Trading Ekosistem', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-8', position: 'Sekretaris Bidang Bisnis Kemitraan & UMKM', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-9', position: 'Sekretaris Bidang Digital & Teknologi', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-10', position: 'Sekretaris Bidang Adab & Budaya', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-11', position: 'Sekretaris Bidang Hukum & Advokasi', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-12', position: 'Sekretaris Bidang Haji dan Umroh', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-13', position: 'Sekretaris Bidang Pengembangan SDM & Diklat', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-14', position: 'Sekretaris Bidang Ekspor Impor', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-15', position: 'Sekretaris Bidang Hubungan Masyarakat & Media', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-16', position: 'Sekretaris Bidang Teknologi & Inovasi', name: '(Kosong)', status: 'pending' as const },
        { id: 'sk-17', position: 'Sekretaris Bidang Kemitraan Internasional', name: '(Kosong)', status: 'pending' as const },
      ]
    },
  ]
};
...
export const DEWAN_PENDIRI_LENGKAP = [
  { id: 'pendiri-1', name: 'Drs. H. Arif Rachman Hakim, M.M.', position: 'Pendiri ke-1 — Sekretaris Jenderal / CEO NB', role: 'Inisiator Architect Koperasi Nusa Berdikari Merah Putih, President Director Top Umroh', status: 'filled' as const },
  { id: 'pendiri-2', name: 'Dr. N. Rusmiati, M.Si., M.H.', position: 'Pendiri ke-2 — Presiden / Ketua Umum (Bakornas)', role: 'Ketua Umum DPP ASITA 2019–2029, CEO & Owner PT Patih Indo Group', status: 'filled' as const },
  { id: 'pendiri-3', name: 'Prof. Wirono, S.E., M.Pd.', position: 'Pendiri ke-3 — Wakil Ketua Umum', role: 'Mantan Marketing AJB Bumi Putera (1995–1999), Mantan Caleg DPRD DKI Jakarta', status: 'filled' as const },
  ...
  { id: 'pendiri-11', name: 'Dr. Heri Solahudin', position: 'Pendiri ke-11 — Anggota Dewan Penasehat', role: 'Peneliti Senior CSEAS Kyoto University, Penulis "The Roots of ISIS in Indonesia"', status: 'filled' as const },
  { id: 'pendiri-12', name: 'Ir. Endro Wuryanto, M.M.', position: 'Pendiri ke-12 — Koordinator Bidang Infrastruktur Digital', role: 'Koordinator Bidang Infrastruktur Digital', status: 'filled' as const },
  { id: 'pendiri-13', name: 'Sae Tanangga Karim, S.E.', position: 'Pendiri ke-13 — Koordinator Bidang Event Organizer', role: 'General Manager PT Dyandra Promosindo (pengelola IIMS, pameran internasional)', status: 'filled' as const },
  { id: 'pendiri-14', name: 'Hj. Inna Hadianala, S.E.', position: 'Pendiri ke-14 — Koordinator Bidang Pengembangan SDM & Organisasi', role: 'Ex. Anggota DPRD Prov. Jawa Tengah, Mantan Anggota DPRD Kabupaten Cilacap (Fraksi PPP), Wakil Sekretaris DPW PPP Jawa Tengah', status: 'filled' as const },
  { id: 'pendiri-15', name: 'Andi Darmadji, S.E.', position: 'Pendiri ke-15 — Koordinator Wilayah Kalimantan', role: 'Panglima Wilayah Kalimantan (Bakorwil), Pilar Ekspansi Kawasan Timur & IKN', status: 'filled' as const },
  { id: 'pendiri-16', name: '(Posisi Belum Terisi)', position: 'Pendiri ke-16 — (Belum Terisi)', role: 'Menunggu Pengesahan', status: 'vacant' as const },
  { id: 'pendiri-17', name: 'dr. Hanson Barki', position: 'Pendiri ke-17 — Koordinator Bidang Adab dan Budaya', role: 'Dokter, Komisaris Utama PT Hanara Batik', status: 'filled' as const },
];
