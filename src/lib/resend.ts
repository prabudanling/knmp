// ============================================
// KMN BERDIKARI - Email Service via Resend
// ============================================
...
export function generatePendaftaranDiterimaEmail(params: {
  ...
  return {
    subject: `Pendaftaran KMN BERDIKARI Diterima - ${noRegistrasi}`,
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
            ...
            <p>Selamat! Pendaftaran Anda sebagai anggota <strong>Koperasi Jasa Multipihak Nusa Berdikari Merah Putih Indonesia (KMN BERDIKARI)</strong> telah diterima.</p>
          ...
          <div style="text-align: center; padding: 20px; color: #666; font-size: 12px;">
            <p>© 2026 Koperasi Jasa Multipihak Nusa Berdikari Merah Putih Indonesia (KMN BERDIKARI)</p>
...
Selamat! Pendaftaran Anda sebagai anggota Koperasi Jasa Multipihak Nusa Berdikari Merah Putih Indonesia (KMN BERDIKARI) telah diterima.
...
© 2026 Koperasi Jasa Multipihak Nusa Berdikari Merah Putih Indonesia (KMN BERDIKARI)
    `.trim(),
  };
}
...
export function generatePembayaranBerhasilEmail(params: {
  ...
  return {
    subject: `Pembayaran KMN BERDIKARI Berhasil - ${noRegistrasi}`,
    html: `
      <!DOCTYPE html>
      <html>
        <head>
...
export function generateApproveEmail(params: {
  ...
  return {
    subject: `🎉 Selamat! Anda Resmi Anggota KMN BERDIKARI - NIAK: ${niakFormatted}`,
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: linear-gradient(135deg, #8B0000 0%, #008F3D 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
            ...
            <p style="color: white; margin: 10px 0 0 0;">Anda Resmi Menjadi Anggota KMN BERDIKARI</p>
          </div>
          <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
            <p>Yth. <strong>${namaLengkap}</strong>,</p>
            <p>Selamat! Anda telah resmi menjadi anggota <strong>Koperasi Jasa Multipihak Nusa Berdikari Merah Putih Indonesia (KMN BERDIKARI)</strong>.</p>
            ...
            <ul>
              ...
              <li>Transaksi di marketplace KMN BERDIKARI</li>
...
Selamat! Anda telah resmi menjadi anggota Koperasi Jasa Multipihak Nusa Berdikari Merah Putih Indonesia (KMN BERDIKARI).
...
- Transaksi di marketplace KMN BERDIKARI
...
export function generateRejectEmail(params: {
  ...
  return {
    subject: `Pendaftaran KMN BERDIKARI Ditolak - ${noRegistrasi}`,
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
            <p>Yth. <strong>${namaLengkap}</strong>,</p>
            <p>Mohon maaf, pendaftaran Anda sebagai anggota Koperasi Jasa Multipihak Nusa Berdikari Merah Putih Indonesia (KMN BERDIKARI) tidak dapat disetujui.</p>
...
Mohon maaf, pendaftaran Anda sebagai anggota Koperasi Jasa Multipihak Nusa Berdikari Merah Putih Indonesia (KMN BERDIKARI) tidak dapat disetujui.
